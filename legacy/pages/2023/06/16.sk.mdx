...
## 16. júna 2023### [Protest proti výpadku Redditu bude pokračovať na neurčito](https://old.reddit.com/r/technology/comments/149zmar/reddits_blackout_protest_is_set_to_continue/)- Protest proti výpadku Redditu pokračuje na neurčito, pričom mnohé populárne subreddity sú stále nedostupné.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36341941)- Lemmy sa považuje za potenciálnu náhradu za Reddit s jeho federatívnym systémom komunít.
...
### [Reddit hrozí, že odstráni moderátorov zo subredditov pokračujúcich vo výpadkoch](https://www.macrumors.com/2023/06/15/reddit-threatens-to-remove-subreddit-moderators/)- Spoločnosť Reddit hrozí odstránením moderátorov zo subredditov, ktoré pokračujú vo výpadkoch protestujúcich proti plánom spoločnosti účtovať vysoké ceny za svoje API.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36347711)- Internetové komunity závislé od platforiem sociálnych médií, ako sú Facebook, Twitter a Reddit, si uvedomujú svoju závislosť od sprostredkovateľov zameraných na zisk.
...
### [Môj 24-ročný HP Jornada dokáže veci, ktoré iPhone stále nedokáže](https://raymii.org/s/blog/My_24_year_old_HP_Jornada_can_do_things_your_modern_iPhone_still_cant_do.html)- Autor rozoberá svoje obľúbené retro zariadenie HP Jornada 720, čo je malý vreckový počítač vydaný v roku 1999, na ktorom beží Windows CE alebo Linux.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36346254)- Diskusia sa sústreďuje na "walled garden" spoločnosti Apple a kontrolu používateľov nad zariadeniami.
...
### [Sekvenčné diagramy, jediná dobrá vec, ktorú UML priniesol do vývoja softvéru](https://www.mermaidchart.com/blog/posts/sequence-diagrams-the-good-thing-uml-brought-to-software-development)- Sekvenčné diagramy sú užitočným spôsobom, ako zdokumentovať vzájomnú interakciu rôznych častí systému.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36342931)- Mnohí vývojári považujú sekvenčné diagramy za najužitočnejší typ diagramu UML.
...
### [Náš plán pre Python 3.13](https://github.com/faster-cpython/ideas/blob/main/3.13/README.md)- Plán pre Python 3.13 je podobný predchádzajúcemu plánu pre 3.12, ale s niekoľkými dôležitými rozdielmi.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36339777)- Komunita používateľov jazyka Python je rozdelená v otázke, či odstrániť GIL z jazyka CPython.
...
### [Effective Rust (2021)](https://www.lurklurk.org/effective-rust/)- Tento príspevok sa týka zlepšovania kódu Rust a používania osvedčených postupov.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36338529)- Príspevok sa zaoberá efektívnym programovaním v jazyku Rust a rieši potenciálne nedostatky a nesúhlas s odporúčaniami autora.
...
### [Unihiker, jednodoskový počítač za 80 USD s 2,8" dotykovou obrazovkou, štvorjadrovým procesorom ARM Cortex-A35](https://www.unihiker.com/)- Unihiker je jednodoskový počítač (SBC) s 2,8-palcovou dotykovou obrazovkou, Wi-Fi a Bluetooth.
...
#### [Reakcie priemyslu](http://news.ycombinator.com/item?id=36341287)- Niektorí používatelia sa domnievajú, že zariadeniu Unihiker chýba podpora ekosystému a má zastaraný softvérový zásobník, takže je mŕtve hneď pri príchode.
...
## Archeológovia našli 3 000 rokov starý meč, výnimočne dobre zachovaný](https://newsingermany.com/archaeologists-find-3000-year-old-sword/)### [Reakcie z odvetvia](http://news.ycombinator.com/item?id=36340671)- V Nemecku bol objavený 3000 rokov starý meč, výnimočne dobre zachovaný.
...
### [O pomalej produktivite Johna Wicka](https://calnewport.com/on-the-slow-productivity-of-john-wick/)- Úspech filmu John Wick sa pripisuje jeho vizuálne strhujúcim akčným sekvenciám.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36335104)- Príspevok pojednáva o pomalej produktivite Johna Wicka a o tom, ako súvisí s konceptom hlbokej práce.
...
### [11 rokov hostingu SaaS](https://ghiculescu.substack.com/p/11-years-of-hosting-a-saas)- Autor sa zamýšľa nad svojimi skúsenosťami s 11-ročným hosťovaním aplikácie SaaS a delí sa o získané skúsenosti.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36336748)- Využívanie riadených služieb môže ušetriť čas a zdroje pri vytváraní produktu.
