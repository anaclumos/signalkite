...
## 18 de junho de 2023### [Tipo de letra matricial do metro de Londres](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- O tipo de letra London Underground Dot Matrix Typeface é um conjunto de tipos de letra que reproduzem os tipos de letra utilizados nos painéis de chegada e nos painéis de anúncios do sistema de transportes do metropolitano de Londres.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36367667)- O tipo de letra Dot Matrix do metro de Londres foi recriado por um designer e disponibilizado no GitHub.
...
### [Atualização: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- O post investiga a origem e a história do símbolo U+237C ⍼ RIGHT ANGLE WITH DOWNWARDS ZIGZAG ARROW na norma Unicode.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36369553)- O artigo aborda a procura do significado e da origem de um símbolo misterioso chamado U+237C ⍼ &Angzarr;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Os empregos da treta são cargos inúteis e desnecessários que existem tanto no sector público como no privado, causando frustração entre os trabalhadores e minando o verdadeiro objetivo das organizações.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36373190)- O livro "Bullshit Jobs" de David Graeber explora o conceito de empregos que são considerados inúteis ou desnecessários pelos próprios trabalhadores.
...
### [GB Studio: criador de jogos retro de arrastar e largar para GameBoy](https://www.gbstudio.dev/)- O GB Studio é um criador de jogos de arrastar e largar de fácil utilização que permite criar jogos retro para o sistema de videojogos portátil GameBoy.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36372284)- GB Studio é um criador de jogos retro para o GameBoy que permite aos utilizadores arrastar e largar para criar jogos.
...
### [Não preciso da vossa linguagem de consulta](https://antonz.org/fancy-ql/)- O autor expressa a sua frustração com o aparecimento de novas linguagens de consulta na indústria e argumenta que a utilização da SQL como linguagem de base comum para bases de dados de uso geral é mais prática e eficiente.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36369018)- As consultas SQL podem ter inconvenientes quando se trata de consultar bases de dados com diferentes tipos e multiplicidade, conduzindo a resultados redundantes e à falta de tratamento de erros.
...
### [O molho secreto por trás da janela de contexto de 100K em LLMs: todos os truques em um só lugar](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- O post discute técnicas para acelerar o treinamento e a inferência de Modelos de Linguagem Grande (LLMs) para usar uma janela de contexto de até 100 mil tokens de entrada, que é significativamente maior do que os modelos anteriores.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36374936)- O modelo de 100k da Anthropics utiliza técnicas inteligentes para alargar a janela de contexto, mas tem algumas imperfeições.
...
### [As pessoas podem ser convencidas de que cometeram um crime que nunca aconteceu (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- A investigação mostra que indivíduos inocentes podem ser convencidos, através de técnicas de interrogatório adequadas, de que cometeram um crime que nunca aconteceu de facto.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36367147)- A técnica Reid utilizada pelas autoridades policiais pode levar a falsas confissões e condenações injustas.
...
#### [Reacções da indústria](http://news.ycombinator.com/item?id=36368990)- Os utilizadores questionam a razão pela qual a Apple não adicionou uma funcionalidade de encaixe de janelas ao macOS, expressando a sua frustração com o comportamento predefinido do botão verde nas janelas do macOS.
...
### [Revisão dos servidores ARM64 da Hetzner e experiência dos serviços de nuvem WebP neles](https://blog.webp.se/hetzner-arm64-en/)- A análise do desempenho dos servidores ARM64 da Hetzner mostra que têm um desempenho muito bom, com a máquina CAX21 a ser apenas 8% mais lenta do que a máquina CPX21 na velocidade de conversão WebP.
...
#### [Reacções da Indústria](http://news.ycombinator.com/item?id=36368586)- O autor do artigo cometeu um erro ao descrever o processador E3-1230 como um servidor de 8 núcleos, quando na realidade é um servidor de 4 núcleos com 8 threads.
...
### [Mesclando bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- O sistema de ficheiros bcachefs, destinado a fornecer alto desempenho e fiabilidade, está a aproximar-se da fusão com o kernel Linux principal.
...
#### [Reações da Indústria](http://news.ycombinator.com/item?id=36366002)- Bcachefs, um novo sistema de ficheiros, está em processo de ser integrado no kernel do Linux.
