...
### Stripe müzik dolabı hizmetimi öldürdü, bu yüzden açık kaynak kullanıyorum

- Gönderinin yazarı, Stripe tarafından kapatılmasının ardından müzik dolabı hizmetini açık kaynak olarak sunuyor.
...
### YouTube: En eskiye göre sırala geri döndü bebeğim

- YouTube, kullanıcıların bir kanaldaki en eski videoları görüntülemesine olanak tanıyan "En Eskiye Göre Sırala" özelliğini geri getirdi.
