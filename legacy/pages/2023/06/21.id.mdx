...
### Stripe mematikan layanan loker musik saya, jadi saya menggunakan sumber terbuka

- Penulis artikel ini menggunakan layanan loker musik mereka secara open source setelah layanan ini ditutup oleh Stripe.
...
### YouTube: Urutkan dari yang tertua adalah bayi kembali

- YouTube telah mengembalikan fitur "Urutkan berdasarkan yang Tertua", yang memungkinkan pengguna untuk melihat video tertua di sebuah saluran.
