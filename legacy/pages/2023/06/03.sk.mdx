...
### [3. júna 2023 [Brute.Fail: Sledovanie zlyhania útokov hrubou silou v reálnom čase](https://brute.fail/)- Brute.Fail ukazuje príklady útočníkov, ktorí sa v reálnom čase pokúšajú preniknúť na servery hádaním používateľských mien a hesiel.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36169954)- Používanie fail2ban môže šetriť prostriedky servera zastavením odpovedí na útoky hrubou silou, ale nemusí im zabrániť.
...
### [Kalifornia minula 17 miliárd dolárov na bezdomovectvo - nefunguje to](https://www.wsj.com/articles/california-homeless-population-oakland-wood-street-encampment-78d42cc3)- Kalifornia vynaložila na bezdomovectvo 17 miliárd dolárov, ale problém pretrváva.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36162154)- Kalifornia vynaložila 17 miliárd dolárov na boj proti bezdomovectvu, ale nefunguje to, pričom stratégia "housing first" sa v San Franciscu napriek úspechu vo Fínsku nerealizuje efektívne.
...
### [Aplikácie Reddit tretích strán sú drvené zvyšovaním cien](https://kotaku.com/reddit-third-party-3rd-apps-pricing-crush-ios-android-1850493992)- Aplikácie tretích strán, ako napríklad Apollo a Infinity, sú vytláčané z trhu kvôli novým poplatkom, ktoré zaviedla spoločnosť Reddit za prístup k svojmu API.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36162235)- Aplikáciám tretích strán Reddit sa zvyšujú ceny za prístup k API, čo vyvoláva obavy o vzťah medzi Redditom a jeho používateľmi.
...
### [Radiačne odolný Quine (2014)](https://github.com/mame/radiation-hardened-quine)- Radiation-hardened Quine je samočinný program napísaný v jazyku Ruby, ktorý funguje, aj keď z kódu vymažete znak.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36162164)- O radiačne odolný quine, ktorý znesie vymazanie jedného znaku bez toho, aby to ovplyvnilo jeho spustiteľnosť, sa podelil hacker na Hacker News.
...
### [Ako vytvoriť fantastické mapy ciest pomocou R a OpenStreetMap](https://www.andrewheiss.com/blog/2023/06/01/geocoding-routing-openstreetmap-r/)- Andrew Heiss vysvetľuje, ako použil OpenStreetMap, R, `sf` a `ggplot2` na vytvorenie cestovných máp.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36159864)- Komentátori diskutujú o historických a geologických informáciách o regiónoch pozdĺž trasy cesty- Diskusia o používaní R verzus Python na tvorbu máp- Niektorí komentátori sa delia o vlastné skúsenosti s plánovaním ciest a navrhujú nástroje alebo knižnice na tvorbu máp

### [Po 27 rokoch a Psion 3a je stále úžasný (2020)](https://mcgst.com/2020/12/01/27-years-later-and-the-psion-3a-is-still-wonderful/)- Psion 3a, vreckový počítač PDA vydaný v roku 1993, je aj po 27 rokoch stále funkčný a má mnoho inovatívnych funkcií.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36162265)- Technickí nadšenci diskutujú o Psione 3a a vyjadrujú nostalgiu za jeho tvarovým faktorom a užívateľsky prívetivým rozhraním.
...
### [Skenovanie záloh iPhonu na stopy po kompromitácii pomocou operácie "Triangulation"](https://github.com/KasperskyLab/triangle_check)- Nový skript s názvom Triangle Check dokáže skenovať zálohy iTunes na stopy kompromitácie pomocou "Operácie Triangulation".
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36164340)- Spoločnosť Kaspersky Lab vydala nástroj "Operation Triangulation", ktorý dokáže skenovať zálohy iPhonu na účely kompromitácie.
...
### [Nie je zlé, že "🤦🏼♂".length == 7 (2019)](https://hsivonen.fi/string-length/)- Článok skúma rôzne spôsoby, akými programovacie jazyky definujú a merajú dĺžku reťazca, konkrétne pokiaľ ide o Unicode a emotikony.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36159443)- V článku sa diskutuje o nejednoznačnosti atribútu "dĺžka" pre reťazce a navrhuje sa jeho nahradenie presnejšími deskriptormi.
...
#### [Reakcie odvetvia](http://news.ycombinator.com/item?id=36168068)- Gilbert Strang, slávny matematik a odborník na lineárnu algebru, odišiel do dôchodku po 61 rokoch pedagogickej kariéry.
