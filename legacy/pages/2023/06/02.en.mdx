...
### [June 2, 2023 [Learn x86-64 assembly by writing a GUI from scratch](https://gaultier.github.io/blog/x11_x64.html)- The article provides a tutorial on how to write an assembly program that opens a GUI window using X11 without external libraries, emphasizing the use of system calls and stack pointers.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36153237)- Practical ways to learn assembly include writing a simple GUI from scratch, studying the 8086 manual, and translating machine code to assembly instructions.
...
### [I made CSS Pro, a re-imagined Devtools for web design](https://csspro.com)- CSS Pro is a browser extension that allows for visual editing of CSS, generating code on-the-fly and allowing changes to any website's design with just a few clicks.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36148807)- CSS Pro is a new design tool with real-time synchronization between the code and the browser, featuring useful features like a gradient/bkg generator and real-time measurements of image content.
...
### [Zig is hard but worth it](http://ratfactor.com/zig/hard)- Zig programming language is considered challenging but rewarding to master for its unique features that contribute to writing performant software and learning memory management.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36149462)- Zig, a new language, is easy to learn but hard to master, and some criticize the poor documentation and inconsistent stdlib.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36149004)- The Dutch government has mandated the use of security.txt files on websites to improve cybersecurity and facilitate reporting of vulnerabilities.
...
### Who is hiring? (June 2023)- This post is a forum for job seekers in the tech industry to share information about job openings at their companies or to seek out job opportunities.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36152014)- "Ask Discussion Service" thread where companies can post job listings with various locations and roles- Notable companies include Minion.AI and Zulip- Positions available for software engineers, assistant directors, security engineers, full-stack developers, data engineers, NLP/ML engineers, product engineers, and more

### [Meta announces its Quest 3 VR headset](https://www.theverge.com/2023/6/1/23744576/meta-quest-3-vr-headset-price-details)- Meta has announced its Quest 3 VR headset, which will be released this fall and cost $499.99 for the 128GB version.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36151375)- Meta has announced the upcoming release of their new VR headset, the Quest 3, with improved performance and a slimmer design compared to its predecessor, although some users express concerns about potential drawbacks of the new design.
...
### [I went down the rabbit hole of buying GitHub Stars, so you won't have to](https://the-guild.dev/blog/judging-open-source-by-github-stars)- The article explores the trend of buying GitHub stars as a marketing technique, and the author conducted an experiment of buying stars from different platforms.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36151140)- Purchasing GitHub stars with bots is a way to defeat abuse protection measures with legitimate-looking activity, which is an unfortunate side effect of online marketing.
...
### [Lost John Coltrane recording, from experimental phase with Eric Dolphy, emerges](https://www.npr.org/2023/05/31/1179098682/john-coltrane-eric-dolphy-village-gate-1961-lost-album)- After being lost for over 60 years, a recording of John Coltrane and Eric Dolphy's experimental performance at the Village Gate in New York has been found and will be released by Impulse! Records on July 14.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36146905)- "Lost" John Coltrane recording from experimental phase with Eric Dolphy emerges.

- Jazz fans excited over previously unheard versions of "Impressions."
- No meaningful tech news in this post.

### [Was modern art a CIA psy-op? (2020)](https://daily.jstor.org/was-modern-art-really-a-cia-psy-op/)- Modern art was a weapon of the Cold War, with both the State Department and CIA supporting exhibitions of American art all over the world.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36155204)- The article raises the question of whether modern art, particularly abstract expressionism, was part of a CIA propaganda campaign during the Cold War era.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36149789)- Industry documents reveal manufacturers of "forever chemicals" covered up health risks, leading to increased risk of cancer and other disorders.
