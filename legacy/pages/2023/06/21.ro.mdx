...
### Stripe mi-a omorât serviciul meu de stocare a muzicii, așa că îl fac open sourcing

- Autorul postării este open sourcing serviciul lor de blocare a muzicii după ce a fost închis de Stripe.
...
- YouTube a restabilit funcția "Sort by Oldest", permițând utilizatorilor să vizualizeze cele mai vechi videoclipuri de pe un canal.
