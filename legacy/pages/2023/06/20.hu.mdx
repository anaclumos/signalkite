...
### [2023. június 20. [A PostgreSQL újragondolja folyamatalapú modelljét](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- A PostgreSQL, egy népszerű adatbázis-rendszer, alapvető változtatást fontolgat, hogy eltávolodjon folyamatközpontú modelljétől.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36393030)- A PostgreSQL fontolgatja a folyamatalapú modellről a szálalapú modellre való áttérést.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- Az OpenLLM egy nyílt platform a nagy nyelvi modellek (LLM) termelésben történő működtetésére.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36388219)- Az OpenLLM egy nyílt platform a nagyméretű nyelvi modellek (LLM) termelésben történő működtetésére.
...
### [A Titanic turista tengeralattjáró eltűnt, a keresés folyamatban van](https://www.bbc.com/news/world-us-canada-65953872)- Eltűnt egy turista tengeralattjáró, a Titanic tengeralattjáró, amely az Atlanti-óceán közepén a Titanic roncsához merült. A tengeralattjáró öt személyt tud befogadni, és egy nyolcnapos, 250 000 dollárba kerülő útra készült.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36391053)- Eltűnt a Titanic felfedezése közben az OceanGate által épített Titan nevű turista tengeralattjáró, a keresés folyamatban van.
...
### [A Twitter jogászai túlterheltek, mivel az elbocsátott alkalmazottak választottbírósági kereseteket nyújtanak be](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- A Twitter ügyvédei az elbocsátott alkalmazottak által benyújtott választottbírósági keresetek hullámával szembesülnek.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36390308)- A Twitter volt alkalmazottai választottbírósági keresetet nyújtottak be, amelyben a nekik ígért elmaradt fizetést, költségtérítést és végkielégítést követelik.
...
### [Egy indie játék egyszerre 3 konzolon való megjelenése és pénzügyi kudarc (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- A "Toto Temple Deluxe" című indie játék egyszerre több konzolon is megjelent, de anyagilag nem fogyott jól.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36387030)- A bejegyzés egy olyan indie játékfejlesztő kihívásait tárgyalja, aki egyszerre három konzolra is kiadta játékát, és anyagilag megbukott.
...
### [A fehérnél világosabb szín megjelenítése Apple készülékeken](https://github.com/dtinth/superwhite)- A bejegyzés a "superwhitedisplay" nevű technikát mutatja be, amely lehetővé teszi a felhasználók számára, hogy HDR-támogatással rendelkező Apple készülékeken nagyon világos fehér színt jelenítsenek meg.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36389285)- Az Apple készülékek a HDR technológia segítségével a fehérnél világosabb színeket is képesek megjeleníteni.
...
### [Megpróbáltunk vonatjegyet foglalni, és végül 245 ezer rekordot tartalmazó adatsértés történt](https://zerforschung.org/posts/freundschaftspass-en/)- A cikk egy olyan adatvédelmi incidenst tárgyal, amely a fiatal felnőttek számára Németországban és Franciaországban ingyenesen kiadott vonatjegyek elosztása során történt. A jogsértés következtében körülbelül 245 000 regisztrációs adat került nyilvánosságra.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36388828)- Az MCI és a Caracal ügynökségek által végrehajtott projekt, amely a megfelelő architektúra, tervezés és tesztelés hiánya miatt gyakran rendszerhibákkal járt.
...
### [A TypeScript 5.2 új kulcsszava: "Using"](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Ez a bejegyzés elmagyarázza, hogy a TypeScriptben az {} miért nem jelent valójában üres objektumot.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36388894)- A TypeScript 5.2 bevezet egy új kulcsszót, a "Using" kulcsszót az erőforrás-kezeléshez.
...
### [Slint - Deklaratív felhasználói felület eszközkészlet beágyazott és asztali eszközökhöz](https://slint.dev)- A Slint egy deklaratív UI eszközkészlet, amely lehetővé teszi a fejlesztők számára, hogy natív felhasználói felületeket készítsenek beágyazott rendszerekhez és asztali alkalmazásokhoz.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36388821)- A Slint egy deklaratív, elsősorban Rust nyelven írt GUI eszközkészlet, amelyet asztali és beágyazott használatra terveztek.
...
### [Első benyomásaim a Nixről](https://mtlynch.io/notes/nix-first-impressions/)- A Nix egy eszköz a szoftverkörnyezetek forrásfájlok segítségével történő konfigurálására, és egyre népszerűbb a fejlesztők körében.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36387874)- A Nix egy olyan build rendszer, amely a funkcionális programozási koncepciókat öleli fel, és lehetővé teszi a reprodukálható, gyorsítótárazott buildeket.
