...
### [June 18, 2023 [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- The London Underground Dot Matrix Typeface is a set of fonts that replicate the typefaces used on the arrival boards and announcement boards of the London Underground transportation system.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36367667)- The London Underground Dot Matrix Typeface has been recreated by a designer and made available on GitHub.
...
### [Update: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- The post investigates the origin and history of the symbol U+237C ⍼ RIGHT ANGLE WITH DOWNWARDS ZIGZAG ARROW in the Unicode standard.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36369553)- The article discusses the search for the meaning and origin of a mysterious symbol called U+237C ⍼ &Angzarr;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Bullshit jobs are pointless and unnecessary positions that exist in both the public and private sectors, causing frustration among employees and undermining the true purpose of organizations.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36373190)- The book "Bullshit Jobs" by David Graeber explores the concept of jobs that are perceived as pointless or unnecessary by employees themselves.
...
### [GB Studio: Drag and drop retro game creator for GameBoy](https://www.gbstudio.dev/)- GB Studio is a user-friendly drag and drop game creator that allows you to make retro games for the GameBoy handheld video game system.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36372284)- GB Studio is a retro game creator for the GameBoy that allows users to drag and drop to create games.
...
### [I don't need your query language](https://antonz.org/fancy-ql/)- The author expresses their frustration with the emergence of new query languages in the industry and argues that using SQL as a common ground language for general-purpose databases is more practical and efficient.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36369018)- SQL queries can have drawbacks when it comes to querying databases with different types and multiplicity, leading to redundant output and lack of error handling.
...
### [The Secret Sauce behind 100K context window in LLMs: all tricks in one place](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- The post discusses techniques to speed up training and inference of Large Language Models (LLMs) to use a context window of up to 100K input tokens, which is significantly larger than previous models.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36374936)- Anthropics' 100k model employs clever techniques to extend the context window, but it has some imperfections.
...
### [People can be convinced they committed a crime that never happened (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- Research shows that innocent individuals can be convinced, through proper questioning techniques, that they have committed a crime that never actually happened.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36367147)- The Reid technique used by law enforcement can lead to false confessions and wrongful convictions.
...
### Why does Apple refuse to add window snapping to macOS?- The post discusses why Apple has not added a feature called "window snapping" to its macOS operating system.- Window snapping is a feature that allows users to easily arrange and resize open windows on their computer screen.

- The post explores different perspectives on why Apple may have chosen not to include this feature in macOS.

#### [Industry Reactions](http://news.ycombinator.com/item?id=36368990)- Users are questioning why Apple has not added a window snapping feature to macOS, expressing frustration with the default behavior of the green button on macOS windows.
...
### [Review of Hetzner ARM64 servers and experience of WebP cloud services on them](https://blog.webp.se/hetzner-arm64-en/)- The performance review of Hetzner's ARM64 servers shows that they perform very well, with the CAX21 machine only being 8% slower than the CPX21 machine in WebP conversion speed.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36368586)- The author of the article made a mistake in describing the E3-1230 processor as an 8-core server when it is actually a 4-core server with 8 threads.
...
### [Merging bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- The bcachefs filesystem, aimed at providing high performance and reliability, is getting closer to being merged into the mainline Linux kernel.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36366002)- Bcachefs, a new file system, is in the process of being merged into the Linux kernel.
