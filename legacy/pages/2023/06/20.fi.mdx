...
### [20. kesäkuuta 2023 [PostgreSQL harkitsee uudelleen prosessipohjaista malliaan](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, suosittu tietokantajärjestelmä, harkitsee perustavanlaatuista muutosta siirtyäkseen pois prosessipohjaisesta mallistaan.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36393030)- PostgreSQL harkitsee siirtymistä prosessipohjaisesta mallista säikeisiin perustuvaan malliin.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM on avoin alusta suurten kielimallien (LLM) käyttämiseen tuotannossa.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36388219)- OpenLLM on avoin alusta suurten kielimallien (LLM) tuotantokäyttöön.
...
### [Titanicin turisti-sukellusvene katoaa ja etsinnät ovat käynnissä](https://www.bbc.com/news/world-us-canada-65953872)- Turistisukellusvene, Titan-sukellusvene, on kadonnut sukelluksen aikana Titanicin hylylle Atlantin keskiosassa. Sukellusveneeseen mahtuu viisi ihmistä, ja se oli kahdeksan päivän matkalla, joka maksoi 250 000 dollaria.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36391053)- OceanGaten rakentama Titan-niminen turistisukellusvene on kadonnut Titanicin tutkimisen aikana, ja etsinnät ovat käynnissä.
...
### [Twitterin lakimiehet ovat hukkua irtisanottujen työntekijöiden jättämiin välimiesmenettelyvaatimuksiin](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Twitterin lakimiehet joutuvat kohtaamaan irtisanottujen työntekijöiden välimiesoikeudellisten vaateiden vyöryn.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36390308)- Entiset Twitterin työntekijät ovat esittäneet välimiesoikeudellisia vaatimuksia, joissa he vaativat takaisinmaksettuja palkkoja, kulukorvauksia ja erorahoja, jotka heille oli luvattu.
...
### [Indie-pelin julkaiseminen kolmelle konsolille samanaikaisesti ja taloudellinen epäonnistuminen (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- Indiepeli "Toto Temple Deluxe" julkaistiin usealla konsolilla samanaikaisesti, mutta se ei myynyt taloudellisesti hyvin.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36387030)- Postauksessa käsitellään haasteita, joita kohtasi indie-pelikehittäjä, joka julkaisi pelinsä samanaikaisesti kolmelle konsolille ja epäonnistui taloudellisesti.
...
### [Näytä valkoista kirkkaampi väri Applen laitteissa](https://github.com/dtinth/superwhite)- Postauksessa esitellään "superwhitedisplay" -niminen tekniikka, jonka avulla käyttäjät voivat näyttää erittäin kirkkaan valkoisen värin Applen laitteissa, joissa on HDR-tuki.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36389285)- Applen laitteet voivat näyttää valkoista kirkkaammat värit HDR-tekniikan avulla.
...
### [Yritimme varata junalippua ja päädyimme 245 000 tietueen tietomurtoon](https://zerforschung.org/posts/freundschaftspass-en/)- Artikkelissa käsitellään tietomurtoa, joka tapahtui nuorille aikuisille suunnattujen ilmaisten junalippujen jakamisen yhteydessä Saksassa ja Ranskassa. Tietomurto johti noin 245 000 rekisteröintitiedoston paljastumiseen.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36388828)- Virastojen MCI ja Caracal toteuttama hanke, johon liittyy usein järjestelmähäiriöitä, jotka johtuvat asianmukaisen arkkitehtuurin, suunnittelun ja testauksen puutteesta.
...
### [TypeScript 5.2:n uusi avainsana: 'Using'](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Tässä postauksessa selitetään, miksi {} ei TypeScriptissä todellisuudessa edusta tyhjää objektia.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 esittelee uuden avainsanan "Using" resurssien hallintaa varten.
...
### [Slint - deklaratiivinen käyttöliittymätyökalupakki sulautettuihin ja työpöytätietokoneisiin](https://slint.dev)- Slint on deklaratiivinen käyttöliittymätyökalupakki, jonka avulla kehittäjät voivat rakentaa natiiveja käyttöliittymiä sulautettuihin järjestelmiin ja työpöytäsovelluksiin.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36388821)- Slint on pääasiassa Rust-kielellä kirjoitettu deklaratiivinen graafisen käyttöliittymän työkalupakki, joka on suunniteltu työpöytä- ja sulautettuun käyttöön.
...
### [Ensivaikutelmani Nixistä](https://mtlynch.io/notes/nix-first-impressions/)- Nix on työkalu ohjelmistoympäristöjen konfigurointiin lähdetiedostojen avulla, ja se on kasvattamassa suosiotaan kehittäjien keskuudessa.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36387874)- Nix on build-järjestelmä, joka omaksuu funktionaalisen ohjelmoinnin käsitteet ja mahdollistaa toistettavat, välimuistiin tallennetut buildit.
