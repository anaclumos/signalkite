...
### [20 czerwca 2023 [PostgreSQL ponownie rozważa swój model oparty na procesach](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, popularny system baz danych, rozważa wprowadzenie fundamentalnej zmiany w celu odejścia od modelu zorientowanego na procesy.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36393030)- PostgreSQL rozważa przejście z modelu opartego na procesach na model oparty na wątkach.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM to otwarta platforma do obsługi dużych modeli językowych (LLM) w produkcji.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36388219)- OpenLLM to otwarta platforma do obsługi dużych modeli językowych (LLM) w produkcji.
...
### [Turystyczna łódź podwodna Titanic zaginęła, trwają poszukiwania](https://www.bbc.com/news/world-us-canada-65953872)- Turystyczna łódź podwodna Titan zaginęła podczas nurkowania na wraku Titanica na środkowym Atlantyku. Łódź podwodna mieści pięć osób i odbyła ośmiodniową wycieczkę, której koszt wyniósł 250 000 USD.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36391053)- Turystyczna łódź podwodna o nazwie Titan, zbudowana przez OceanGate, zaginęła podczas eksploracji Titanica i trwają jej poszukiwania.
...
### [Prawnicy Twittera przytłoczeni roszczeniami arbitrażowymi zwolnionych pracowników](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Prawnicy Twittera zmagają się z napływem roszczeń arbitrażowych od zwolnionych pracowników.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36390308)- Byli pracownicy Twittera złożyli pozwy arbitrażowe o zaległe wynagrodzenie, zwrot kosztów i odprawę, którą im obiecano.
...
### [Wydanie gry niezależnej na 3 konsole jednocześnie i porażka finansowa (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- Niezależna gra "Toto Temple Deluxe" została wydana na wielu konsolach jednocześnie, ale nie sprzedała się dobrze finansowo.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36387030)- W poście omówiono wyzwania, przed którymi stanął niezależny twórca gier, który wydał swoją grę jednocześnie na trzy konsole i poniósł porażkę finansową.
...
### [Wyświetl kolor jaśniejszy niż biały na urządzeniach Apple](https://github.com/dtinth/superwhite)- Post przedstawia technikę o nazwie "superwhitedisplay", która pozwala użytkownikom wyświetlać bardzo jasny biały kolor na urządzeniach Apple z obsługą HDR.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36389285)- Urządzenia Apple mogą wyświetlać kolory jaśniejsze niż biały dzięki technologii HDR.
...
### [Próbowaliśmy zarezerwować bilet kolejowy, a skończyło się na naruszeniu 245 tys. rekordów danych](https://zerforschung.org/posts/freundschaftspass-en/)- Artykuł omawia naruszenie danych, do którego doszło podczas dystrybucji bezpłatnych biletów kolejowych dla młodych dorosłych w Niemczech i Francji. Naruszenie spowodowało ujawnienie około 245 000 rekordów rejestracyjnych.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36388828)- Projekt wdrożony przez agencje MCI i Caracal, często związany z awariami systemu z powodu braku odpowiedniej architektury, planowania i testowania.
...
### [Nowe słowo kluczowe TypeScript 5.2: "Using"](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Ten post wyjaśnia, dlaczego {} w TypeScript nie reprezentuje w rzeczywistości pustego obiektu.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 wprowadza nowe słowo kluczowe o nazwie "Using" do zarządzania zasobami.
...
### [Slint - A declarative UI toolkit for embedded and desktop](https://slint.dev)- Slint to deklaratywny zestaw narzędzi UI, który umożliwia programistom tworzenie natywnych interfejsów użytkownika dla systemów wbudowanych i aplikacji desktopowych.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36388821)- Slint to deklaratywny zestaw narzędzi GUI napisany głównie w języku Rust, przeznaczony do użytku na komputerach stacjonarnych i wbudowanych.
...
### [Moje pierwsze wrażenia z Nix](https://mtlynch.io/notes/nix-first-impressions/)- Nix to narzędzie do konfigurowania środowisk programistycznych przy użyciu plików źródłowych, które zyskuje coraz większą popularność wśród programistów.
...
#### [Reakcje branży](http://news.ycombinator.com/item?id=36387874)- Nix to system kompilacji, który obejmuje koncepcje programowania funkcjonalnego i pozwala na powtarzalne, buforowane kompilacje.
