...
### Stripe ha ucciso il mio servizio di music locker, quindi ne sto facendo open sourcing

- L'autore del post sta aprendo il proprio servizio di music locker dopo la chiusura da parte di Stripe.
...
### YouTube: L'ordinamento in base al più vecchio è tornato

- YouTube ha ripristinato la funzione "Ordina per vecchio", che consente agli utenti di visualizzare i video più vecchi di un canale.
