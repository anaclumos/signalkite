...
## 20. června 2023### [PostgreSQL přehodnocuje svůj procesní model](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, populární databázový systém, zvažuje zásadní změnu, aby se vzdálil od svého procesně orientovaného modelu.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36393030)- PostgreSQL zvažuje přechod z procesního modelu na model založený na vláknech.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM je otevřená platforma pro provozování velkých jazykových modelů (LLM) ve výrobě.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36388219)- OpenLLM je otevřená platforma pro provozování velkých jazykových modelů (LLM) ve výrobě.
...
### [Turistická ponorka Titanic se pohřešuje a probíhá po ní pátrání](https://www.bbc.com/news/world-us-canada-65953872)- Turistická ponorka Titan se ztratila během ponoru k vraku Titaniku ve středním Atlantiku. Ponorka pojme pět osob a byla na osmidenní výpravě, která stála 250 000 dolarů.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36391053)- Při průzkumu Titaniku se pohřešuje turistická ponorka Titan, kterou postavila společnost OceanGate, a probíhá po ní pátrání.
...
### [Právníci Twitteru jsou zahlceni, protože propuštění zaměstnanci podávají arbitrážní žaloby](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Právníci společnosti Twitter čelí náporu arbitrážních žalob od propuštěných zaměstnanců.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36390308)- Bývalí zaměstnanci společnosti Twitter podali arbitrážní žaloby, v nichž se domáhají vrácení mzdy, náhrady výdajů a odstupného, které jim bylo přislíbeno.
...
### [Vydání nezávislé hry na třech konzolích najednou a finanční neúspěch (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- Nezávislá hra "Toto Temple Deluxe" byla vydána na více konzolích současně, ale finančně se neprodávala dobře.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36387030)- Příspěvek pojednává o problémech, kterým čelil nezávislý vývojář, který vydal svou hru současně na tři konzole a finančně neuspěl.
...
### [Zobrazení jasnější než bílé barvy na zařízeních Apple](https://github.com/dtinth/superwhite)- Příspěvek představuje techniku nazvanou "superwhitedisplay", která umožňuje uživatelům zobrazit velmi jasnou bílou barvu na zařízeních Apple s podporou HDR.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36389285)- Zařízení Apple mohou pomocí technologie HDR zobrazovat jasnější než bílé barvy.
...
### [Pokusili jsme se rezervovat jízdenku na vlak a skončilo to únikem dat o 245 tisících záznamů](https://zerforschung.org/posts/freundschaftspass-en/)- Článek pojednává o úniku dat, ke kterému došlo při distribuci bezplatných jízdenek na vlak pro mladé lidi v Německu a Francii. Výsledkem narušení bylo odhalení přibližně 245 000 registračních záznamů.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36388828)- Projekt realizovaný agenturami MCI a Caracal, často spojený se selháním systému v důsledku nedostatečné architektury, plánování a testování.
...
### [Nové klíčové slovo jazyka TypeScript 5.2: 'Using'](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Tento příspěvek vysvětluje, proč {} v jazyce TypeScript ve skutečnosti nepředstavuje prázdný objekt.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 zavádí nové klíčové slovo "Using" pro správu prostředků.
...
### [Slint - Deklarativní sada nástrojů uživatelského rozhraní pro vestavěné a stolní počítače](https://slint.dev)- Slint je deklarativní sada nástrojů uživatelského rozhraní, která vývojářům umožňuje vytvářet nativní uživatelská rozhraní pro vestavěné systémy a desktopové aplikace.
...
#### [Reakce z oboru](http://news.ycombinator.com/item?id=36388821)- Slint je deklarativní sada nástrojů pro grafické uživatelské rozhraní napsaná primárně v jazyce Rust a určená pro použití v desktopech a vestavěných aplikacích.
...
### [Moje první dojmy z Nixu](https://mtlynch.io/notes/nix-first-impressions/)- Nix je nástroj pro konfiguraci softwarového prostředí pomocí zdrojových souborů a mezi vývojáři si získává stále větší oblibu.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36387874)- Nix je systém sestavení, který zahrnuje koncepty funkcionálního programování a umožňuje reprodukovatelné sestavení v mezipaměti.
