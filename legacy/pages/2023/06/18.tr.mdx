...
## 18 Haziran 2023### [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- London Underground Dot Matrix Yazı Karakteri, Londra Metrosu ulaşım sisteminin varış panolarında ve duyuru panolarında kullanılan yazı karakterlerini kopyalayan bir yazı tipi setidir.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36367667)- Londra Metrosu Nokta Matris Yazı Tipi bir tasarımcı tarafından yeniden oluşturuldu ve GitHub'da kullanıma sunuldu.
...
### [Güncelleme: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- Bu yazı, Unicode standardındaki U+237C ⍼ AŞAĞI DOĞRU ZİGZAG OK İLE SAĞ AÇI sembolünün kökenini ve geçmişini araştırmaktadır.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36369553)- Makale, U+237C ⍼ &Angzarr adlı gizemli bir sembolün anlamını ve kökenini araştırmayı tartışıyor;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Saçma işler, hem kamu hem de özel sektörde var olan, çalışanlar arasında hayal kırıklığına neden olan ve kuruluşların gerçek amacını baltalayan anlamsız ve gereksiz pozisyonlardır.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36373190)- David Graeber'in "Saçma İşler" adlı kitabı, çalışanların kendileri tarafından anlamsız veya gereksiz olarak algılanan işler kavramını incelemektedir.
...
### [GB Studio: GameBoy için sürükle ve bırak retro oyun yaratıcısı](https://www.gbstudio.dev/)- GB Studio, GameBoy el video oyun sistemi için retro oyunlar yapmanızı sağlayan kullanıcı dostu bir sürükle ve bırak oyun yaratıcısıdır.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36372284)- GB Studio, GameBoy için kullanıcıların sürükleyip bırakarak oyun oluşturmalarına olanak tanıyan retro bir oyun yaratıcısıdır.
...
### [Sorgu dilinize ihtiyacım yok](https://antonz.org/fancy-ql/)- Yazar, sektörde yeni sorgu dillerinin ortaya çıkmasından duydukları hayal kırıklığını dile getirmekte ve genel amaçlı veritabanları için ortak bir zemin dili olarak SQL kullanmanın daha pratik ve verimli olduğunu savunmaktadır.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36369018)- SQL sorguları, farklı türlere ve çokluğa sahip veritabanlarını sorgulamak söz konusu olduğunda, gereksiz çıktılara ve hata işleme eksikliğine yol açan dezavantajlara sahip olabilir.
...
### [LLM'lerde 100K bağlam penceresinin arkasındaki Gizli Sos: tüm hileler tek bir yerde](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- Bu yazıda, Büyük Dil Modellerinin (LLM'ler) eğitimini ve çıkarımını hızlandırmak için, önceki modellerden önemli ölçüde daha büyük olan 100K giriş jetonuna kadar bir bağlam penceresi kullanma teknikleri tartışılmaktadır.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36374936)- Anthropics'in 100k modeli bağlam penceresini genişletmek için akıllı teknikler kullanmaktadır, ancak bazı kusurları vardır.
...
### [İnsanlar hiç gerçekleşmemiş bir suç işlediklerine ikna olabilirler (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- Araştırmalar, masum kişilerin, uygun sorgulama teknikleriyle, aslında hiç gerçekleşmemiş bir suçu işlediklerine ikna edilebildiklerini göstermektedir.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36367147)- Kolluk kuvvetleri tarafından kullanılan Reid tekniği yanlış itiraflara ve haksız mahkumiyetlere yol açabilir.
...
### Apple macOS'a pencere yaslama özelliğini eklemeyi neden reddediyor?- Yazıda Apple'ın macOS işletim sistemine neden "window snapping" adı verilen bir özellik eklemediği tartışılıyor.- Pencere yakalama, kullanıcıların bilgisayar ekranlarındaki açık pencereleri kolayca düzenlemelerine ve yeniden boyutlandırmalarına olanak tanıyan bir özelliktir.

- Yazı, Apple'ın bu özelliği macOS'a neden eklememeyi tercih etmiş olabileceğine dair farklı bakış açılarını araştırıyor.

#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36368990)- Kullanıcılar, Apple'ın macOS'a neden bir pencere yakalama özelliği eklemediğini sorguluyor ve macOS pencerelerindeki yeşil düğmenin varsayılan davranışından duydukları hayal kırıklığını dile getiriyor.
...
### [Hetzner ARM64 sunucularının incelenmesi ve bunlar üzerinde WebP bulut hizmetleri deneyimi](https://blog.webp.se/hetzner-arm64-en/)- Hetzner'in ARM64 sunucularının performans incelemesi, CAX21 makinesinin WebP dönüştürme hızında CPX21 makinesinden yalnızca %8 daha yavaş olmasıyla çok iyi performans gösterdiklerini göstermektedir.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36368586)- Makalenin yazarı, aslında 8 iş parçacıklı 4 çekirdekli bir sunucu olan E3-1230 işlemciyi 8 çekirdekli bir sunucu olarak tanımlarken bir hata yapmıştır.
...
### [Birleştirme bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- Yüksek performans ve güvenilirlik sağlamayı amaçlayan bcachefs dosya sistemi, ana Linux çekirdeği ile birleştirilmeye yaklaşıyor.
...
#### [Sektör Tepkileri](http://news.ycombinator.com/item?id=36366002)- Yeni bir dosya sistemi olan Bcachefs, Linux çekirdeği ile birleştirme sürecindedir.
