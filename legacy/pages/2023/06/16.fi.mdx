...
### [16. kesäkuuta 2023 [Redditin sähkökatkosprotesti jatkuu toistaiseksi](https://old.reddit.com/r/technology/comments/149zmar/reddits_blackout_protest_is_set_to_continue/)- Redditin blackout-protesti jatkuu toistaiseksi, ja monet suositut subredditit ovat edelleen saavuttamattomissa.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36341941)- Lemmy nähdään potentiaalisena korvaajana Redditille, jossa on yhteisöjä yhdistävä järjestelmä.
...
### [Reddit uhkaa poistaa moderaattorit subredditeistä, jotka jatkavat sähkökatkoksia](https://www.macrumors.com/2023/06/15/reddit-threatens-to-remove-subreddit-moderators/)- Reddit uhkaa poistaa moderaattorit subredditeistä, jotka jatkavat katkoksia protestoidessaan yhtiön suunnitelmia periä korkeita hintoja API:sta.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36347711)- Facebookin, Twitterin ja Redditin kaltaisiin sosiaalisen median alustoihin tukeutuvat internet-yhteisöt ovat ymmärtämässä riippuvuutensa voittoa tavoittelevista välittäjistä.
...
### [24 vuotta vanha HP Jornadani voi tehdä asioita, joita iPhone ei vieläkään pysty tekemään](https://raymii.org/s/blog/My_24_year_old_HP_Jornada_can_do_things_your_modern_iPhone_still_cant_do.html)- Kirjoittaja kertoo suosikkiretrolaitteestaan, HP Jornada 720:sta, joka on vuonna 1999 julkaistu pieni kämmentietokone, jossa toimii Windows CE tai Linux.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36346254)- Keskustelu keskittyy Applen walled gardeniin ja laitteiden käyttäjähallintaan.
...
### [Sekvenssikaaviot, ainoa hyvä asia, jonka UML toi ohjelmistokehitykseen](https://www.mermaidchart.com/blog/posts/sequence-diagrams-the-good-thing-uml-brought-to-software-development)- Sekvenssikaaviot ovat hyödyllinen tapa dokumentoida, miten järjestelmän eri osat ovat vuorovaikutuksessa keskenään.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36342931)- Monet kehittäjät pitävät sekvenssikaavioita hyödyllisimpänä UML-kaaviotyyppinä.
...
### [Suunnitelmamme Python 3.13:lle](https://github.com/faster-cpython/ideas/blob/main/3.13/README.md)- Suunnitelma Python 3.13:lle on samanlainen kuin edellinen suunnitelma 3.12:lle, mutta siinä on joitakin tärkeitä eroja.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36339777)- Python-yhteisö on eri mieltä siitä, pitäisikö GIL poistaa CPythonista.
...
### [Effective Rust (2021)](https://www.lurklurk.org/effective-rust/)- Tämä viesti koskee Rust-koodin parantamista ja parhaiden käytäntöjen käyttöä.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36338529)- Postauksessa käsitellään tehokasta Rust-ohjelmointia ja käsitellään mahdollisia puutteita ja erimielisyyksiä kirjoittajan suosituksista.
...
### [Unihiker, 80 dollarin hintainen tietokone, jossa on 2,8 tuuman kosketusnäyttö, neliytiminen ARM Cortex-A35](https://www.unihiker.com/)- Unihiker on yhden piirilevyn tietokone (SBC), jossa on 2,8 tuuman kosketusnäyttö, Wi-Fi ja Bluetooth.
...
#### [Teollisuuden reaktiot](http://news.ycombinator.com/item?id=36341287)- Joidenkin käyttäjien mielestä Unihikerilta puuttuu ekosysteemituki, ja sen ohjelmistopino on vanhentunut, joten se on kuollut heti saapuessaan.
...
#### [Arkeologit löysivät 3000 vuotta vanhan miekan, joka on säilynyt poikkeuksellisen hyvin](https://newsingermany.com/archaeologists-find-3000-year-old-sword/) [Teollisuuden reaktiot](http://news.ycombinator.com/item?id=36340671)- Saksasta on löydetty 3000 vuotta vanha miekka, joka on poikkeuksellisen hyvin säilynyt.
...
### [John Wickin hitaasta tuottavuudesta](https://calnewport.com/on-the-slow-productivity-of-john-wick/)- John Wick -elokuvan menestys johtuu sen visuaalisesti vangitsevista toimintakohtauksista.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36335104)- Postauksessa keskustellaan John Wickin hitaasta tuottavuudesta ja siitä, miten se liittyy syvällisen työn käsitteeseen.
...
### [11 vuotta SaaS-isännöintiä](https://ghiculescu.substack.com/p/11-years-of-hosting-a-saas)- Kirjoittaja pohtii kokemuksiaan SaaS-sovelluksen isännöinnistä 11 vuoden ajan ja kertoo oppimastaan.
...
#### [Alan reaktiot](http://news.ycombinator.com/item?id=36336748)- Hallinnoitujen palvelujen käyttäminen voi säästää aikaa ja resursseja tuotetta rakennettaessa.
