...
## 2023. június 18.### [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- A London Underground Dot Matrix Typeface egy olyan betűtípus-készlet, amely a londoni metró közlekedési rendszerének érkezési tábláin és hirdetőtábláin használt betűtípusokat utánozza.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36367667)- A London Underground Dot Matrix Typeface-t egy tervező újraalkotta és elérhetővé tette a GitHubon.
...
### [Frissítés: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- A bejegyzés az U+237C ⍼ Jobbszög lefelé mutató cikcakkos nyíllal (RIGHT ANGLE WITH DOWNWARDS ZIGZAG ARROW) szimbólum eredetét és történetét vizsgálja az Unicode-szabványban.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36369553)- A cikk az U+237C ⍼ &Angzarr nevű rejtélyes szimbólum jelentésének és eredetének kutatását tárgyalja;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- A Bullshit Jobs olyan értelmetlen és felesleges pozíciók, amelyek mind a köz-, mind a magánszektorban léteznek, frusztrációt okozva az alkalmazottak körében és aláásva a szervezetek valódi célját.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36373190)- David Graeber "Bullshit Jobs" című könyve az olyan munkák fogalmát vizsgálja, amelyeket maguk a munkavállalók értelmetlennek vagy szükségtelennek tartanak.
...
### [GB Studio: Drag and drop retro játékkészítő GameBoyhoz](https://www.gbstudio.dev/)- A GB Studio egy felhasználóbarát drag and drop játékkészítő program, amellyel retró játékokat készíthetünk a GameBoy kézi videojáték-rendszerre.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36372284)- A GB Studio egy retro játékkészítő a GameBoyhoz, amely lehetővé teszi a felhasználók számára, hogy drag and drop segítségével hozzanak létre játékokat.
...
### [Nem kell a lekérdezési nyelv](https://antonz.org/fancy-ql/)- A szerző kifejezi csalódottságát az iparágban megjelenő új lekérdezési nyelvek megjelenésével kapcsolatban, és amellett érvel, hogy az SQL mint általános célú adatbázisok közös alapnyelvének használata praktikusabb és hatékonyabb.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36369018)- Az SQL-lekérdezéseknek lehetnek hátrányai, amikor különböző típusú és sokaságú adatbázisok lekérdezéséről van szó, ami redundáns kimenethez és a hibakezelés hiányához vezet.
...
### [A titkos szósz a 100K kontextusablak mögött az LLM-ekben: minden trükk egy helyen](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- A bejegyzés olyan technikákat tárgyal, amelyekkel felgyorsítható a nagy nyelvi modellek (Large Language Models, LLM) képzése és következtetése, hogy akár 100K bemeneti tokenből álló kontextusablakot használhassanak, ami jelentősen nagyobb, mint a korábbi modellek.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36374936)- Az Anthropics 100k modellje okos technikákat alkalmaz a kontextusablak meghosszabbítására, de van néhány hiányossága.
...
### [Az emberek meg lehetnek győződve arról, hogy olyan bűncselekményt követtek el, ami meg sem történt (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- A kutatások azt mutatják, hogy ártatlan embereket megfelelő kikérdezési technikákkal meg lehet győzni arról, hogy olyan bűncselekményt követtek el, amely valójában meg sem történt.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36367147)- A bűnüldözés által alkalmazott Reid-technika hamis vallomásokhoz és téves elítélésekhez vezethet.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36368990)- A felhasználók megkérdőjelezik, hogy az Apple miért nem adta hozzá a macOS-hez az ablakpattintás funkciót, és csalódottságuknak adnak hangot a macOS ablakok zöld gombjának alapértelmezett viselkedése miatt.
...
### [A Hetzner ARM64 kiszolgálók áttekintése és a WebP felhőszolgáltatásokkal kapcsolatos tapasztalatok](https://blog.webp.se/hetzner-arm64-en/)- A Hetzner ARM64 szervereinek teljesítményvizsgálata azt mutatja, hogy nagyon jól teljesítenek, a CAX21 gép WebP-konverziós sebessége mindössze 8%-kal lassabb, mint a CPX21 gépé.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36368586)- A cikk szerzője hibát követett el, amikor az E3-1230 processzort 8-magos szerverként írta le, holott valójában egy 4-magos szerverről van szó 8 szálakkal.
...
### [bcachefs összevonása](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- A nagy teljesítményt és megbízhatóságot biztosítani hivatott bcachefs fájlrendszer egyre közelebb kerül ahhoz, hogy beolvadjon a fővonalbeli Linux kernelbe.
...
#### [Ipari reakciók](http://news.ycombinator.com/item?id=36366002)- A bcachefs, egy új fájlrendszer, jelenleg a Linux kernelbe való beolvasztás folyamatában van.
