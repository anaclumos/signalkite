---
localized_date: 16. června 2023
top_news: Protest proti výpadku Redditu bude pokračovat na neurčito
---
...
## 16. června 2023### [Protest proti výpadku Redditu bude pokračovat na neurčito](https://old.reddit.com/r/technology/comments/149zmar/reddits_blackout_protest_is_set_to_continue/)- Protest proti výpadku Redditu pokračuje na dobu neurčitou, mnoho populárních subredditů je stále nedostupných.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36341941)- Lemmy je považován za potenciální náhradu Redditu s jeho federativním systémem komunit.
...
### [Reddit hrozí odstraněním moderátorů ze subredditů pokračujících ve výpadcích](https://www.macrumors.com/2023/06/15/reddit-threatens-to-remove-subreddit-moderators/)- Reddit hrozí odstraněním moderátorů ze subredditů, které pokračují ve výpadcích protestujících proti plánům společnosti účtovat vysoké ceny za své API.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36347711)- Internetové komunity závislé na platformách sociálních médií, jako jsou Facebook, Twitter a Reddit, si uvědomují svou závislost na ziskových zprostředkovatelích.
...
### [Moje 24 let stará HP Jornada umí věci, které iPhone ještě neumí](https://raymii.org/s/blog/My_24_year_old_HP_Jornada_can_do_things_your_modern_iPhone_still_cant_do.html)- Autor pojednává o svém oblíbeném retro zařízení HP Jornada 720, což je malý kapesní počítač vydaný v roce 1999, na kterém běží Windows CE nebo Linux.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36346254)- Debata se soustřeďuje na uzavřenou zahradu společnosti Apple a uživatelskou kontrolu nad zařízeními.
...
### [Sekvenční diagramy, jediná dobrá věc, kterou UML přinesl do vývoje softwaru](https://www.mermaidchart.com/blog/posts/sequence-diagrams-the-good-thing-uml-brought-to-software-development)- Sekvenční diagramy jsou užitečným způsobem, jak dokumentovat, jak spolu různé části systému interagují.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36342931)- Sekvenční diagramy jsou mnoha vývojáři považovány za nejužitečnější typ diagramu UML.
...
### [Náš plán pro Python 3.13](https://github.com/faster-cpython/ideas/blob/main/3.13/README.md)- Plán pro Python 3.13 je podobný předchozímu plánu pro verzi 3.12, ale s několika důležitými rozdíly.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36339777)- Komunita uživatelů jazyka Python je rozdělena v názoru na to, zda odstranit GIL z jazyka CPython.
...
### [Effective Rust (2021)](https://www.lurklurk.org/effective-rust/)- Tento příspěvek se zabývá vylepšováním kódu v jazyce Rust a používáním osvědčených postupů.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36338529)- Příspěvek pojednává o efektivním programování v jazyce Rust a zabývá se možnými nedostatky a nesouhlasem s autorovými doporučeními.
...
### [Unihiker, jednodeskový počítač za 80 dolarů s 2,8" dotykovou obrazovkou, čtyřjádrový ARM Cortex-A35](https://www.unihiker.com/)- Unihiker je jednodeskový počítač (SBC) s 2,8palcovou dotykovou obrazovkou, Wi-Fi a Bluetooth.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36341287)- Někteří uživatelé se domnívají, že Unihiker postrádá podporu ekosystému a má zastaralý softwarový stack, takže je mrtvý hned při příchodu.
...
### [Archeologové našli 3000 let starý meč, výjimečně dobře zachovalý](https://newsingermany.com/archaeologists-find-3000-year-old-sword/)#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36340671)- V Německu byl objeven 3000 let starý meč, výjimečně dobře zachovalý.
...
### [O pomalé produktivitě Johna Wicka](https://calnewport.com/on-the-slow-productivity-of-john-wick/)- Úspěch filmu John Wick je připisován jeho vizuálně strhujícím akčním sekvencím.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36335104)- Příspěvek pojednává o pomalé produktivitě Johna Wicka a o tom, jak souvisí s konceptem hluboké práce.
...
### [11 let hostování SaaS](https://ghiculescu.substack.com/p/11-years-of-hosting-a-saas)- Autor se zamýšlí nad svými zkušenostmi s hostováním aplikace SaaS po dobu 11 let a sdílí zkušenosti, které se naučil.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36336748)- Využívání řízených služeb může ušetřit čas a zdroje při vytváření produktu.
