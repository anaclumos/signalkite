...
## 18. Juni 2023### [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- Bei der London Underground Dot Matrix Typeface handelt es sich um eine Reihe von Schriftarten, die die auf den Ankunfts- und Ankündigungstafeln der Londoner U-Bahn verwendeten Schriftarten nachbilden.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36367667)- Die London Underground Dot Matrix Typeface wurde von einem Designer neu erstellt und auf GitHub zur Verfügung gestellt.
...
### [Update: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- Der Beitrag untersucht den Ursprung und die Geschichte des Symbols U+237C ⍼ RIGHT ANGLE WITH DOWNWARDS ZIGZAG ARROW im Unicode-Standard.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36369553)- Der Artikel behandelt die Suche nach der Bedeutung und dem Ursprung eines mysteriösen Symbols namens U+237C ⍼ &Angzarr;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Bullshit-Jobs sind sinnlose und unnötige Positionen, die es sowohl im öffentlichen als auch im privaten Sektor gibt, die Frustration unter den Beschäftigten verursachen und den wahren Zweck von Organisationen untergraben.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36373190)- Das Buch "Bullshit Jobs" von David Graeber befasst sich mit dem Konzept von Arbeitsplätzen, die von den Arbeitnehmern selbst als sinnlos oder unnötig empfunden werden.
...
### [GB Studio: Drag and drop retro game creator for GameBoy](https://www.gbstudio.dev/)- GB Studio ist ein benutzerfreundlicher Drag-and-Drop-Spieleentwickler, mit dem Sie Retro-Spiele für das GameBoy-Handheld-Videospielsystem erstellen können.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36372284)- GB Studio ist ein Programm zur Erstellung von Retro-Spielen für den GameBoy, mit dem der Benutzer per Drag & Drop Spiele erstellen kann.
...
### [Ich brauche Ihre Abfragesprache nicht](https://antonz.org/fancy-ql/)- Der Autor bringt seine Frustration über das Aufkommen neuer Abfragesprachen in der Industrie zum Ausdruck und argumentiert, dass die Verwendung von SQL als gemeinsame Grundsprache für Allzweckdatenbanken praktischer und effizienter ist.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36369018)- SQL-Abfragen können Nachteile haben, wenn es darum geht, Datenbanken mit verschiedenen Typen und einer Vielzahl von Daten abzufragen, was zu redundanten Ausgaben und fehlender Fehlerbehandlung führt.
...
### [Die geheime Soße hinter dem 100K-Kontextfenster in LLMs: alle Tricks an einem Ort](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- In diesem Beitrag werden Techniken zur Beschleunigung des Trainings und der Inferenz von Large Language Models (LLMs) erörtert, um ein Kontextfenster von bis zu 100K Eingabe-Token zu verwenden, das deutlich größer ist als bei früheren Modellen.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36374936)- Das 100k-Modell von Anthropics nutzt clevere Techniken zur Erweiterung des Kontextfensters, weist aber einige Mängel auf.
...
### [Menschen können davon überzeugt sein, ein Verbrechen begangen zu haben, das nie stattgefunden hat (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- Die Forschung zeigt, dass unschuldige Personen durch geeignete Befragungstechniken davon überzeugt werden können, dass sie ein Verbrechen begangen haben, das in Wirklichkeit nie stattgefunden hat.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36367147)- Die von den Strafverfolgungsbehörden angewandte Reid-Technik kann zu falschen Geständnissen und unrechtmäßigen Verurteilungen führen.
...
### Warum weigert sich Apple, macOS mit einem Fenster zu versehen?- In diesem Beitrag wird erörtert, warum Apple eine Funktion namens "Window Snapping" nicht in sein Betriebssystem macOS aufgenommen hat.- Das Einrasten von Fenstern ist eine Funktion, die es Benutzern ermöglicht, offene Fenster auf ihrem Computerbildschirm einfach anzuordnen und in der Größe zu verändern.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36368990)- Nutzer fragen sich, warum Apple keine Funktion zum Einrasten von Fenstern in macOS integriert hat und äußern ihre Frustration über das Standardverhalten der grünen Taste in macOS-Fenstern.
...
### [Überprüfung der Hetzner ARM64-Server und Erfahrungen mit WebP-Cloud-Diensten auf ihnen](https://blog.webp.se/hetzner-arm64-en/)- Die Leistungsprüfung der ARM64-Server von Hetzner zeigt, dass sie sehr gut abschneiden, wobei der CAX21-Rechner bei der WebP-Konvertierungsgeschwindigkeit nur 8 % langsamer ist als der CPX21-Rechner.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36368586)- Dem Autor des Artikels ist ein Fehler unterlaufen, als er den E3-1230-Prozessor als 8-Core-Server bezeichnete, obwohl es sich eigentlich um einen 4-Core-Server mit 8 Threads handelt.
...
### [Zusammenführung von bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- Das Dateisystem bcachefs, das hohe Leistung und Zuverlässigkeit bieten soll, rückt näher an die Integration in den Linux-Kernel heran.
...
#### [Reaktionen der Industrie](http://news.ycombinator.com/item?id=36366002)- Bcachefs, ein neues Dateisystem, ist dabei, in den Linux-Kernel integriert zu werden.
