...
## 20 juin 2023### [PostgreSQL reconsidère son modèle basé sur les processus](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, un système de base de données populaire, envisage un changement fondamental pour s'éloigner de son modèle orienté processus.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36393030)- PostgreSQL envisage de passer d'un modèle basé sur les processus à un modèle basé sur les threads.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM est une plateforme ouverte pour l'exploitation de grands modèles de langage (LLM) en production.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36388219)- OpenLLM est une plateforme ouverte pour l'exploitation de grands modèles de langage (LLM) en production.
...
### [Le submersible touristique du Titanic est porté disparu et les recherches sont en cours](https://www.bbc.com/news/world-us-canada-65953872)- Un sous-marin touristique, le Titan submersible, a disparu lors d'une plongée sur l'épave du Titanic au milieu de l'Atlantique. Le submersible peut contenir cinq personnes et effectuait une excursion de huit jours dont le coût s'élevait à 250 000 dollars.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36391053)- Un submersible touristique appelé Titan, construit par OceanGate, a disparu alors qu'il explorait le Titanic, et des recherches sont en cours.
...
### [Les avocats de Twitter sont débordés par les demandes d'arbitrage des employés licenciés](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Les avocats de Twitter sont confrontés à une vague de demandes d'arbitrage de la part d'employés licenciés.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36390308)- D'anciens employés de Twitter ont déposé des demandes d'arbitrage pour réclamer les arriérés de salaire, les remboursements de frais et les indemnités de licenciement qui leur avaient été promis.
...
### [Sortir un jeu indépendant sur 3 consoles à la fois et échouer financièrement (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- Le jeu indépendant "Toto Temple Deluxe" est sorti sur plusieurs consoles simultanément, mais il ne s'est pas bien vendu financièrement.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36387030)- Ce billet traite des difficultés rencontrées par un développeur de jeux indépendants qui a sorti son jeu simultanément sur trois consoles et qui a échoué financièrement.
...
### [Affichage de couleurs plus vives que le blanc sur les appareils Apple](https://github.com/dtinth/superwhite)- Ce billet présente une technique appelée "superwhitedisplay" qui permet aux utilisateurs d'afficher une couleur blanche très brillante sur les appareils Apple prenant en charge le HDR.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36389285)- Les appareils Apple peuvent afficher des couleurs plus vives que le blanc grâce à la technologie HDR.
...
### [Nous avons essayé de réserver un billet de train et nous nous sommes retrouvés avec une violation de données de 245 000 enregistrements](https://zerforschung.org/posts/freundschaftspass-en/)- L'article traite d'une violation de données qui s'est produite lors de la distribution de billets de train gratuits pour les jeunes adultes en Allemagne et en France. La violation a entraîné l'exposition d'environ 245 000 enregistrements.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36388828)- Projet mis en œuvre par les agences MCI et Caracal, souvent associé à des défaillances du système dues à l'absence d'une architecture, d'une planification et de tests appropriés.
...
### [Nouveau mot-clé de TypeScript 5.2 : "Using"](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Ce billet explique pourquoi {} en TypeScript ne représente pas réellement un objet vide.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 introduit un nouveau mot-clé appelé "Using" pour la gestion des ressources.
...
### [Slint - A declarative UI toolkit for embedded and desktop](https://slint.dev)- Slint est une boîte à outils déclarative d'interface utilisateur qui permet aux développeurs de créer des interfaces utilisateur natives pour les systèmes embarqués et les applications de bureau.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36388821)- Slint est une boîte à outils déclarative d'interface graphique écrite principalement en Rust, conçue pour une utilisation bureautique et embarquée.
...
### [Mes premières impressions sur Nix](https://mtlynch.io/notes/nix-first-impressions/)- Nix est un outil permettant de configurer des environnements logiciels à l'aide de fichiers source, et il gagne en popularité auprès des développeurs.
...
#### [Réactions de l'industrie](http://news.ycombinator.com/item?id=36387874)- Nix est un système de construction qui englobe les concepts de programmation fonctionnelle et permet des constructions reproductibles en cache.
