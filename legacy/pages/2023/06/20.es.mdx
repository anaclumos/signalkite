...
## 20 de junio de 2023### [PostgreSQL reconsidera su modelo basado en procesos](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, un popular sistema de bases de datos, está considerando un cambio fundamental para alejarse de su modelo orientado a procesos.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36393030)- PostgreSQL está considerando un cambio de su modelo basado en procesos a un modelo basado en hilos.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM es una plataforma abierta para operar grandes modelos lingüísticos (LLM) en producción.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36388219)- OpenLLM es una plataforma abierta para operar grandes modelos lingüísticos (LLM) en producción.
...
### [Desaparece el sumergible turístico del Titanic y se inicia su búsqueda](https://www.bbc.com/news/world-us-canada-65953872)- Un submarino turístico, el sumergible Titán, ha desaparecido durante una inmersión en los restos del Titanic en el Atlántico Medio. El sumergible tenía capacidad para cinco personas y estaba realizando un viaje de ocho días que costó 250.000 dólares.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36391053)- Un sumergible turístico llamado Titán, construido por OceanGate, ha desaparecido mientras exploraba el Titanic, y se está llevando a cabo una búsqueda.
...
### [Los abogados de Twitter, desbordados ante las demandas de arbitraje de los empleados despedidos](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Los abogados de Twitter se enfrentan a una oleada de demandas de arbitraje de empleados despedidos.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36390308)- Antiguos empleados de Twitter han presentado demandas de arbitraje para reclamar salarios atrasados, reembolsos de gastos e indemnizaciones por despido que se les prometieron.
...
### [Lanzar un juego independiente en 3 consolas a la vez y fracasar económicamente (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- El juego indie "Toto Temple Deluxe" fue lanzado en múltiples consolas simultáneamente, pero no se vendió bien financieramente.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36387030)- En este artículo se analizan las dificultades a las que se enfrentó un desarrollador independiente que lanzó su juego simultáneamente en tres consolas y fracasó económicamente.
...
### [Mostrar color más brillante que el blanco en dispositivos Apple](https://github.com/dtinth/superwhite)- El post presenta una técnica llamada "superwhitedisplay" que permite a los usuarios mostrar un color blanco muy brillante en dispositivos Apple compatibles con HDR.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36389285)- Los dispositivos de Apple pueden mostrar colores más vivos que el blanco gracias a la tecnología HDR.
...
### [Intentamos reservar un billete de tren y acabamos con una filtración de datos de 245.000 registros](https://zerforschung.org/posts/freundschaftspass-en/)- El artículo habla de una filtración de datos que se produjo durante la distribución de billetes de tren gratuitos para jóvenes adultos en Alemania y Francia. La filtración dio lugar a la exposición de aproximadamente 245.000 registros.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36388828)- Proyecto implantado por las agencias MCI y Caracal, a menudo asociado a fallos del sistema por falta de una arquitectura, planificación y pruebas adecuadas.
...
### [La nueva palabra clave de TypeScript 5.2: 'Using'](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Este post explica por qué {} en TypeScript no representa realmente un objeto vacío.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 introduce una nueva palabra clave llamada "Using" para la gestión de recursos.
...
### [Slint - A declarative UI toolkit for embedded and desktop](https://slint.dev)- Slint es un conjunto de herramientas de interfaz de usuario declarativo que permite a los desarrolladores crear interfaces de usuario nativas para sistemas integrados y aplicaciones de escritorio.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36388821)- Slint es un conjunto de herramientas de interfaz gráfica de usuario declarativa escrito principalmente en Rust y diseñado para su uso en ordenadores de sobremesa y sistemas integrados.
...
### [Mis primeras impresiones de Nix](https://mtlynch.io/notes/nix-first-impressions/)- Nix es una herramienta para configurar entornos de software utilizando archivos fuente, y está ganando popularidad entre los desarrolladores.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36387874)- Nix es un sistema de compilación que adopta conceptos de programación funcional y permite compilaciones reproducibles y almacenadas en caché.
