...
### [18 Juni 2023 [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- London Underground Dot Matrix Typeface adalah satu set font yang mereplikasi jenis huruf yang digunakan pada papan kedatangan dan papan pengumuman sistem transportasi London Underground.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36367667)- Jenis Huruf London Underground Dot Matrix telah dibuat ulang oleh seorang desainer dan tersedia di GitHub.
...
### [Pembaruan: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- Tulisan ini menyelidiki asal-usul dan sejarah simbol U+237C ⍼ SUDUT KANAN DENGAN PANAH ZIGZAG KE BAWAH dalam standar Unicode.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36369553)- Artikel ini membahas pencarian arti dan asal usul simbol misterius yang disebut U+237C ⍼ &Angzarr;
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Pekerjaan omong kosong adalah posisi yang tidak berguna dan tidak perlu yang ada di sektor publik dan swasta, yang menyebabkan frustrasi di antara para karyawan dan merusak tujuan sebenarnya dari organisasi.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36373190)- Buku "Bullshit Jobs" oleh David Graeber mengeksplorasi konsep pekerjaan yang dianggap tidak berguna atau tidak perlu oleh karyawan itu sendiri.
...
### [GB Studio: Pencipta game retro seret dan jatuhkan untuk GameBoy](https://www.gbstudio.dev/)- GB Studio adalah pembuat game seret dan lepas yang mudah digunakan yang memungkinkan Anda membuat game retro untuk sistem video game genggam GameBoy.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36372284)- GB Studio adalah pencipta game retro untuk GameBoy yang memungkinkan pengguna untuk menarik dan melepas untuk membuat game.
...
### [Saya tidak membutuhkan bahasa permintaan Anda](https://antonz.org/fancy-ql/)- Penulis mengungkapkan rasa frustasi mereka dengan munculnya bahasa query baru di industri dan berpendapat bahwa menggunakan SQL sebagai bahasa dasar umum untuk database tujuan umum lebih praktis dan efisien.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36369018)- Kueri SQL dapat memiliki kelemahan ketika harus meng-query database dengan berbagai jenis dan keragaman, yang mengarah ke output yang berlebihan dan kurangnya penanganan kesalahan.
...
### [Saus Rahasia di balik jendela konteks 100K di LLM: semua trik di satu tempat](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- Postingan ini membahas teknik untuk mempercepat pelatihan dan inferensi Model Bahasa Besar (LLM) untuk menggunakan jendela konteks hingga 100 ribu token input, yang secara signifikan lebih besar dari model sebelumnya.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36374936)- Model 100k dari Anthropics menggunakan teknik pintar untuk memperpanjang jendela konteks, tetapi memiliki beberapa ketidaksempurnaan.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36367147)- Teknik Reid yang digunakan oleh penegak hukum dapat mengarah pada pengakuan palsu dan vonis yang salah.
...
### Mengapa Apple menolak untuk menambahkan window snapping ke macOS?- Postingan ini membahas mengapa Apple tidak menambahkan fitur yang disebut "window snapping" ke sistem operasi macOS.- Window snapping adalah fitur yang memungkinkan pengguna untuk dengan mudah mengatur dan mengubah ukuran jendela yang terbuka di layar komputer mereka.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36368990)- Pengguna mempertanyakan mengapa Apple tidak menambahkan fitur gertakan jendela ke macOS, mengekspresikan rasa frustrasi dengan perilaku default tombol hijau pada jendela macOS.
...
### [Ulasan server Hetzner ARM64 dan pengalaman layanan cloud WebP di server tersebut](https://blog.webp.se/hetzner-arm64-en/)- Tinjauan kinerja server ARM64 Hetzner menunjukkan bahwa server ini memiliki kinerja yang sangat baik, dengan mesin CAX21 hanya 8% lebih lambat daripada mesin CPX21 dalam kecepatan konversi WebP.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36368586)- Penulis artikel membuat kesalahan dalam mendeskripsikan prosesor E3-1230 sebagai server 8-core padahal sebenarnya ini adalah server 4-core dengan 8 thread.
...
### [Penggabungan bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- Sistem berkas bcachefs, yang ditujukan untuk menyediakan kinerja dan keandalan yang tinggi, semakin dekat untuk digabungkan ke dalam kernel Linux utama.
...
#### [Reaksi Industri](http://news.ycombinator.com/item?id=36366002)- Bcachefs, sebuah sistem berkas baru, sedang dalam proses penggabungan ke dalam kernel Linux.
