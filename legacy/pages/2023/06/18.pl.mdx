...
- Krój London Underground Dot Matrix został odtworzony przez projektanta i udostępniony na GitHub.
...
- Post bada pochodzenie i historię symbolu U+237C ⍼ PRAWY KĄT ZE STRZAŁKĄ W DÓŁ w standardzie Unicode.
...
- GB Studio to kreator gier retro dla GameBoya, który pozwala użytkownikom na tworzenie gier metodą "przeciągnij i upuść".
...
### [Recenzja serwerów Hetzner ARM64 i doświadczeń z usługami chmurowymi WebP na nich](https://blog.webp.se/hetzner-arm64-en/)
