...
### [June 1, 2023 [Had a call with Reddit to discuss pricing](https://old.reddit.com/r/apolloapp/comments/13ws4w3/had_a_call_with_reddit_to_discuss_pricing_bad/)- Reddit is proposing a high pricing structure for its API, which would hinder the future of third-party apps like Apollo.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36141083)- Some Reddit users want to develop a new social media platform due to concerns about high costs, moderation, and censorship.
...
### [Rarbg Is No More](https://web.archive.org/web/20230531105653/https://rarbg.to/index80.php)- Rarbg, a popular torrent site, has announced its decision to shut down due to various reasons including COVID-19 complications, power price increase in data centers, inflation, and team members fighting in Europe.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36136819)- Rarbg has been shut down, and the discussion on Hacker News speculates about illegal activities and how to avoid getting caught.
...
#### [Slide to Unlock](https://cs.uwaterloo.ca/~csk/slide/) [Industry Reactions](http://news.ycombinator.com/item?id=36138304)- Huawei phones have a feature called "AI Touch" that allows users to search and purchase products by touching an image with two fingers.
...
#### Is it just me or GPT-4's quality has significantly deteriorated lately? [Industry Reactions](http://news.ycombinator.com/item?id=36134249)- Users are concerned about a decline in quality and increased bugs with OpenAI's GPT-4 language processing model.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36139852)- The greatest risk of AI is from the people who control it, not the tech itself.
...
### [Nvidia DGX GH200: 100 Terabyte GPU Memory System](https://developer.nvidia.com/blog/announcing-nvidia-dgx-gh200-first-100-terabyte-gpu-memory-system/)- NVIDIA announced the DGX GH200, the first supercomputer with 100 terabytes of memory accessible to GPUs over NVLink, pairing NVIDIA Grace Hopper Superchip with the NVLink Switch System.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36133226)- Nvidia has announced the DGX SuperPOD, a scalable system for AI with 192 A100 GPUs and 15.36 petabytes of memory, improving AI development ease and affordability.
...
### [Notes apps are where ideas go to die (2022)](https://www.reproof.app/blog/notes-apps-help-us-forget)- Notes apps and bookmarking tools are marketed as a "second brain" that helps us remember everything.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36136179)- Note-taking apps can be useful for brainstorming and solidifying ideas.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36144241)- Japan's government will not enforce copyrights on data used for AI training- There is debate about whether AI-generated content constitutes copyright infringement- The extraction of private information and concern for IP violations are potential issues with large language models (LLMs)

### [I try to answer "how to become a systems engineer"](https://rachelbythebay.com/w/2023/05/30/eng/)- An anonymous feedback requested an article on how to become a systems engineer; it is an ambiguous term and involves complex management tasks beyond software development's scope.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36133263)- The post discusses the skills and challenges of becoming a systems engineer, including understanding networks, memory usage, and operating systems.
...
### [Reddit API Pricing Would Cost Apollo Developer $20M per Year](https://daringfireball.net/linked/2023/05/31/reddit-apollo-api-pricing)- Reddit's API pricing would cost Apollo developer, Christian Selig, $20 million per year, after estimating that the 7 billion requests made for Apollo last month would cost $1.7 million per month.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36142285)- Reddit's API pricing would cost Apollo developer $20M per year.
