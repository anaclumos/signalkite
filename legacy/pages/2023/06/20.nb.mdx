...
## 20. juni 2023### [PostgreSQL revurderer sin prosessbaserte modell](https://lwn.net/SubscriberLink/934940/3abb2d4086680b78/)- PostgreSQL, et populært databasesystem, vurderer en grunnleggende endring for å gå bort fra sin prosessorienterte modell.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36393030)- PostgreSQL vurderer å skifte fra sin prosessbaserte modell til en trådbasert modell.
...
### [OpenLLM](https://github.com/bentoml/OpenLLM)- OpenLLM er en åpen plattform for drift av store språkmodeller (LLM) i produksjon.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36388219)- OpenLLM er en åpen plattform for drift av store språkmodeller (LLM) i produksjon.
...
### [Titanic-turistbåten er savnet og søk pågår](https://www.bbc.com/news/world-us-canada-65953872)- En turistubåt, Titan, er forsvunnet under et dykk til vraket av Titanic midt i Atlanterhavet. Undervannsbåten har plass til fem personer og var på en åtte dagers tur som kostet 250 000 dollar.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36391053)- En turistundervannsbåt ved navn Titan, bygget av OceanGate, er savnet under utforskningen av Titanic, og en leteaksjon er i gang.
...
### [Twitter-advokater overveldes når oppsagte ansatte fremmer voldgiftskrav](https://www.techdirt.com/2023/06/16/twitters-lawyers-admit-theyre-overwhelmed-as-nearly-2000-laid-off-employees-file-arbitration-claims/)- Twitters advokater står overfor en bølge av voldgiftskrav fra oppsagte ansatte.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36390308)- Tidligere Twitter-ansatte har fremmet voldgiftskrav om etterbetaling av lønn, refusjon av utgifter og sluttvederlag som de ble lovet.
...
### [Å gi ut et indiespill på tre konsoller samtidig og mislykkes økonomisk (2016)](https://juicybeast.com/2016/01/11/releasing-an-indie-game-on-3-consoles-at-once-and-failing-financially/#2-years)- Indiespillet "Toto Temple Deluxe" ble gitt ut på flere konsoller samtidig, men solgte dårlig økonomisk.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36387030)- Innlegget tar for seg utfordringene til en indiespillutvikler som lanserte spillet sitt samtidig på tre konsoller og mislyktes økonomisk.
...
### [Vises i lysere farger enn hvitt på Apple-enheter](https://github.com/dtinth/superwhite)- Innlegget introduserer en teknikk kalt "superwhitedisplay" som gjør det mulig for brukere å vise en svært lysende hvit farge på Apple-enheter med HDR-støtte.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36389285)- Apple-enheter kan vise lysere farger enn hvitt ved hjelp av HDR-teknologi.
...
### [Vi prøvde å bestille en togbillett og endte opp med et datainnbrudd på 245 000 oppføringer](https://zerforschung.org/posts/freundschaftspass-en/)- Artikkelen tar for seg et datainnbrudd som skjedde i forbindelse med utdeling av gratis togbilletter til unge voksne i Tyskland og Frankrike. Datainnbruddet resulterte i at ca. 245 000 registreringsposter ble eksponert.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36388828)- Prosjekt gjennomført av byråene MCI og Caracal, ofte forbundet med systemfeil på grunn av mangel på riktig arkitektur, planlegging og testing.
...
### [TypeScript 5.2s nye nøkkelord: 'Using'](https://www.totaltypescript.com/typescript-5-2-new-keyword-using)- Dette innlegget forklarer hvorfor {} i TypeScript egentlig ikke representerer et tomt objekt.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36388894)- TypeScript 5.2 introduserer et nytt nøkkelord kalt "Using" for ressurshåndtering.
...
### [Slint - A declarative UI toolkit for embedded and desktop](https://slint.dev)- Slint er en deklarativ UI-verktøysett som gjør det mulig for utviklere å bygge brukergrensesnitt for innebygde systemer og skrivebordsapplikasjoner.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36388821)- Slint er en deklarativ GUI-verktøysett som hovedsakelig er skrevet i Rust, og som er utviklet for stasjonær og innebygd bruk.
...
### [Mitt første inntrykk av Nix](https://mtlynch.io/notes/nix-first-impressions/)- Nix er et verktøy for konfigurering av programvaremiljøer ved hjelp av kildefiler, og det blir stadig mer populært blant utviklere.
...
#### [Reaksjoner fra bransjen](http://news.ycombinator.com/item?id=36387874)- Nix er et byggesystem som omfavner funksjonelle programmeringskonsepter og muliggjør reproduserbare, bufrede bygg.
