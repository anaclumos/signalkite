...
### O Stripe matou o meu serviço de cacifos de música, por isso estou a abri-lo

- O autor do post está a abrir o seu serviço de cacifo de música depois de ter sido encerrado pelo Stripe.
...
### YouTube: Ordenar por mais antigo está de volta, bebé

- O YouTube restaurou o recurso "Classificar por mais antigo", permitindo que os usuários visualizem os vídeos mais antigos de um canal.
