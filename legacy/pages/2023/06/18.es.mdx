...
### ¿Por qué Apple se niega a añadir el ajuste de ventanas a macOS?

- En este artículo se analiza por qué Apple no ha añadido una función llamada "ajuste de ventanas" a su sistema operativo macOS.
