...
## 18 de junio de 2023### [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- London Underground Dot Matrix Typeface es un conjunto de fuentes que reproducen los tipos de letra utilizados en los paneles de llegadas y anuncios de la red de transporte subterráneo de Londres.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36367667)- Un diseñador ha recreado el tipo de letra Dot Matrix del metro de Londres y lo ha publicado en GitHub.
...
### [Actualización: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- El post investiga el origen y la historia del símbolo U+237C ⍼ ÁNGULO DERECHO CON FLECHA EN ZIGZAG HACIA ABAJO en el estándar Unicode.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36369553)- El artículo trata de la búsqueda del significado y el origen de un misterioso símbolo llamado U+237C ⍼ &Angzarr;
...
### [Trabajos de mierda (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- Los trabajos de mierda son puestos inútiles e innecesarios que existen tanto en el sector público como en el privado, causando frustración entre los empleados y socavando el verdadero propósito de las organizaciones.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36373190)- El libro "Bullshit Jobs" de David Graeber explora el concepto de trabajos que los propios empleados perciben como inútiles o innecesarios.
...
### [GB Studio: creador de juegos retro de arrastrar y soltar para GameBoy](https://www.gbstudio.dev/)- GB Studio es un creador de juegos de arrastrar y soltar muy fácil de usar que permite crear juegos retro para el sistema de videojuegos portátil GameBoy.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36372284)- GB Studio es un creador de juegos retro para la GameBoy que permite a los usuarios arrastrar y soltar para crear juegos.
...
### [No necesito tu lenguaje de consulta](https://antonz.org/fancy-ql/)- El autor expresa su frustración por la aparición de nuevos lenguajes de consulta en la industria y argumenta que utilizar SQL como lenguaje de base común para bases de datos de propósito general es más práctico y eficiente.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36369018)- Las consultas SQL pueden presentar inconvenientes cuando se trata de consultar bases de datos de distintos tipos y multiplicidad, lo que conduce a una salida redundante y a la falta de gestión de errores.
...
### [La salsa secreta detrás de la ventana contextual 100K en LLM: todos los trucos en un solo lugar](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- En este artículo se analizan técnicas para acelerar el entrenamiento y la inferencia de los modelos de lenguaje de gran tamaño (LLM) para utilizar una ventana de contexto de hasta 100.000 tokens de entrada, que es significativamente mayor que la de los modelos anteriores.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36374936)- El modelo 100k de Anthropics emplea técnicas inteligentes para ampliar la ventana de contexto, pero tiene algunas imperfecciones.
...
### [La gente puede convencerse de que cometió un crimen que nunca ocurrió (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- Las investigaciones demuestran que se puede convencer a personas inocentes, mediante técnicas de interrogatorio adecuadas, de que han cometido un delito que en realidad nunca ocurrió.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36367147)- La técnica Reid utilizada por las fuerzas del orden puede dar lugar a confesiones falsas y condenas erróneas.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36368990)- Los usuarios se preguntan por qué Apple no ha añadido una función de ajuste de ventanas a macOS, expresando su frustración con el comportamiento por defecto del botón verde en las ventanas de macOS.
...
### [Review of Hetzner ARM64 servers and experience of WebP cloud services on them](https://blog.webp.se/hetzner-arm64-en/)- La revisión del rendimiento de los servidores ARM64 de Hetzner muestra que funcionan muy bien, con la máquina CAX21 siendo sólo un 8% más lenta que la máquina CPX21 en velocidad de conversión WebP.
...
#### [Reacciones del sector](http://news.ycombinator.com/item?id=36368586)- El autor del artículo cometió un error al describir el procesador E3-1230 como un servidor de 8 núcleos cuando en realidad es un servidor de 4 núcleos con 8 hilos.
...
### [Fusión de bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- El sistema de archivos bcachefs, cuyo objetivo es ofrecer un alto rendimiento y fiabilidad, está cada vez más cerca de fusionarse con el núcleo principal de Linux.
...
#### [Reacciones de la industria](http://news.ycombinator.com/item?id=36366002)- Bcachefs, un nuevo sistema de archivos, está en proceso de integración en el núcleo de Linux.
