...
## [Pour tout ce qui date de plus d'un an, il convient d'indiquer la date actuelle.](https://grumpy.website/1389)
...
### [Réactions](https://news.ycombinator.com/item?id=37880818)
...
## [Saper la démocratie : La poussée controversée de la Commission européenne en faveur de la surveillance](https://dannymekic.com/202310/undermining-democracy-the-european-commissions-controversial-push-for-digital-surveillance)
...
### [Réactions](https://news.ycombinator.com/item?id=37880635)


## [Performances de Linux](https://www.brendangregg.com/linuxperf.html)
...
### [Réactions](https://news.ycombinator.com/item?id=37879706)
...
## [La version F-Droid de KDEConnect désinstallée par PlayProtect](https://discuss.kde.org/t/f-droid-version-of-kdeconnect-uninstalled-by-playprotect/5992)
...
### [Réactions](https://news.ycombinator.com/item?id=37879935)


## [Filtre anti-Adblocker uBlock pour se débarrasser du message gênant de YouTube](https://twitter.com/endermanch/status/1713129854818742684)

- Un nouveau filtre a été intégré à uBlock Origin, qui a pour fonction de désactiver la fonction JavaScript anti-adblock sur YouTube.
- Cette innovation apporte une solution aux utilisateurs en éliminant le problème récurrent d'un message irritant.
- UBlock Origin est un outil populaire qui permet aux internautes de contrôler le contenu affiché sur leurs écrans.

### [Réactions](https://news.ycombinator.com/item?id=37884683)
...
## [Le filtre de Kalman à partir de zéro](https://www.kalmanfilter.net/default.aspx)
...
### [Réactions](https://news.ycombinator.com/item?id=37879715)
...
## [Examen des matrices de silicium du processeur Intel 386](http://www.righto.com/2023/10/intel-386-die-versions.html)
...
### [Réactions](https://news.ycombinator.com/item?id=37881656)
...
## [Un module complémentaire de Firefox pour ouvrir les vidéos YouTube dans des interfaces alternatives](https://github.com/d3vr/yt-siphon)
...
### [Réactions](https://news.ycombinator.com/item?id=37881771)
...
## [Les ondes sonores destructrices de tumeurs sont approuvées par la FDA pour le traitement du foie chez l'homme](https://news.umich.edu/tumor-destroying-sound-waves-receive-fda-approval-for-liver-treatment-in-humans/)
...
### [Réactions](https://news.ycombinator.com/item?id=37879893)

- La Food and Drug Administration (FDA) a approuvé l'utilisation d'ondes sonores destructrices de tumeurs pour le traitement du foie chez l'homme.
- Cette technologie est considérée comme une méthode de sauvetage potentiellement importante et peu traumatisante.

## [Pétition contre le contrôle des chats par l'UE](https://stopscanningme.eu/en/index.html)
...
### [Réactions](https://news.ycombinator.com/item?id=37879723)
...
## [Snowden Archive - documents divulgués par Snowden](https://github.com/iamcryptoki/snowden-archive)
...
### [Réactions](https://news.ycombinator.com/item?id=37880033)
...
## [Google a entraîné l'internet dans une "spirale de déclin", affirme le cofondateur de DeepMind](https://www.telegraph.co.uk/business/2023/10/14/google-internet-spiral-of-decline-deepmind-mustafa-suleyman/)

- Le cofondateur de DeepMind, le laboratoire d'intelligence artificielle de Google, affirme que la qualité de l'internet a diminué en raison de la propagation des "appâts à clics" dans les résultats de recherche de Google.
- Selon lui, la volonté de susciter un engagement rapide et important de la part des utilisateurs, souvent par le biais d'un contenu sensationnel ou de titres trompeurs, a eu un impact négatif sur l'expérience des utilisateurs en ligne.
- Ces critiques soulèvent des questions difficiles sur les implications réelles des stratégies d'optimisation des recherches et sur les dommages qu'elles peuvent causer à la crédibilité et à la qualité de l'internet.

### [Réactions](https://news.ycombinator.com/item?id=37887562)

- L'article s'intéresse à divers problèmes contribuant à la dégradation perçue de la qualité de l'internet, notamment les ramifications des algorithmes de classement de Google, les publicités irritantes, les problèmes de protection de la vie privée et les craintes d'escroquerie.
- Il soulève des questions sur la domination de Google et les limites de l'IA pour la recherche et l'extraction d'informations, ainsi que sur les implications éthiques des croyances personnelles dans un système capitaliste.
- Des solutions telles qu'un web durable et une curation améliorée des moteurs de recherche sont proposées, en mettant l'accent sur les complexités et les défis du paysage Internet en évolution.

## [Le Mosquito britannique transportait autrefois Niels Bohr dans sa soute à bombes.](https://www.thedrive.com/the-war-zone/the-nuclear-scientist-and-the-warplane-that-became-britains-most-unlikely-airliner)

- L'avion britannique Mosquito a joué un rôle essentiel pendant la Seconde Guerre mondiale en transportant des fournitures cruciales entre l'Écosse et la Suède, perturbant ainsi la capacité des Allemands à s'assurer les ressources nécessaires.
- Ces activités ont joué un rôle important dans la victoire des Alliés.
- La polyvalence et l'expertise des Mosquito dans diverses fonctions en font un adversaire de taille pour la Luftwaffe, l'armée de l'air allemande.

### [Réactions](https://news.ycombinator.com/item?id=37884749)

- La discussion principale tourne autour de l'histoire de Niels Bohr transporté dans la soute à bombes d'un avion Mosquito britannique.
- La conversation porte sur divers éléments, notamment l'imagerie imaginative, les photos de films anamorphiques, la diffusion stable à source ouverte, les défis de fabrication du Mosquito et des anecdotes personnelles liées à la guerre.
- L'exactitude et la vérifiabilité de l'histoire font l'objet de débats, certains participants mettant en doute les éléments de divertissement utilisés dans le récit et d'autres citant des sources pour étayer sa crédibilité historique.

## [Le déclin de l'activité indépendante comme cause du déclin de la santé mentale de l'enfant](https://cdn2.psychologytoday.com/assets/2023-02/Children%27s%20Independence%20IN%20PRESS%20.pdf)


### [Réactions](https://news.ycombinator.com/item?id=37887071)

- Les discussions mettent l'accent sur les conséquences négatives potentielles sur la santé mentale des enfants en raison de la diminution de leur activité indépendante, et sur le ciblage disproportionné des femmes noires et brunes pauvres par les autorités chargées de la protection de l'enfance.
- Ils suggèrent de modifier les lois relatives à la négligence et à la mise en danger, de créer des quartiers piétonniers, de promouvoir des communautés de confiance et de reconsidérer les dangers des pistes cyclables le long des routes principales dans une culture centrée sur la voiture.
- Les discussions portent également sur des questions sociétales telles que la surprotection des enfants, le contrôle parental excessif, le déclin de l'autonomie des enfants et les effets de la baisse de la fréquentation des églises et de la participation syndicale sur l'atomisation de la société américaine.

## [Les terribles trains allemands ne sont pas une plaisanterie pour une nation qui s'est construite sur l'efficacité](https://www.theguardian.com/business/2023/oct/14/its-the-same-daily-misery-germanys-terrible-trains-are-no-joke-for-a-nation-built-on-efficiency)

- La Deutsche Bahn, l'opérateur ferroviaire national allemand, fait l'objet de critiques en raison d'interruptions de service caractérisées par des retards, des annulations et des fermetures prolongées de tronçons de voies pour des travaux de modernisation.
- Les critiques attribuent ces problèmes au sous-investissement à long terme et à la structure unique de la Deutsche Bahn, qui appartient exclusivement au gouvernement allemand.
- Bien que l'État allemand se soit engagé à investir 40 milliards d'euros supplémentaires dans les chemins de fer, le scepticisme règne quant à la capacité de cet investissement à résoudre les problèmes fondamentaux.

### [Réactions](https://news.ycombinator.com/item?id=37881767)

- L'inadéquation du système ferroviaire allemand provoque des interruptions des liaisons internationales, ce qui conduit la Suisse à refuser l'entrée des trains allemands.
- L'Allemagne est à la traîne en matière de transport de marchandises par train, alors que la Suisse développe son tunnel ferroviaire transeuropéen, ce qui soulève des inquiétudes quant à la réputation de l'Allemagne en matière d'infrastructures publiques efficaces.
- Différents commentaires identifient des facteurs tels que l'insuffisance des investissements, l'obsolescence des technologies et les défis liés à la modernisation des infrastructures, qui entraînent des retards prolongés des trains. Ils mettent également en lumière des problèmes tels que la difficulté à trouver des travailleurs qualifiés, l'impact de la mentalité allemande qui entrave l'amélioration des infrastructures, et les suicides de trains qui entraînent des retards importants.

<head>
  <meta property="og:title" content="Pour tout ce qui date de plus d'un an, il convient d'indiquer la date actuelle." />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Pour%20tout%20ce%20qui%20date%20de%20plus%20d'un%20an%2C%20il%20convient%20d'indiquer%20la%20date%20actuelle.&subheading=dimanche%2015%20octobre%202023%3A%20R%C3%A9sum%C3%A9%20de%20Hacker%20News" />
</head>
