...
- John Riccitiello a démissionné de son poste de PDG d'Unity et James M. Whitehurst, conseiller spécial chez Silver Lake, l'un des principaux actionnaires d'Unity, lui succède par intérim.
...
## [Google a atténué l'attaque DDoS la plus importante à ce jour, avec un pic à plus de 398 millions de rps](https://cloud.google.com/blog/products/identity-security/google-cloud-mitigated-largest-ddos-attack-peaking-above-398-million-rps/)
...
## [Les escaliers médiévaux n'étaient pas construits dans le sens des aiguilles d'une montre pour avantager le défenseur.](https://fakehistoryhunter.net/2023/10/09/medieval-staircases-were-not-built-going-clockwise-for-the-defenders-advantage/)
...
- L'expérience a en outre permis de confirmer que lorsqu'une pièce de monnaie équitable est retournée avec la face initiale déterminée de manière aléatoire, il y a autant de chances que la pièce tombe sur pile ou sur face.
...
## [DSLinux - Linux pour la Nintendo DS](https://www.dslinux.org/)
...
- Bien qu'il n'y ait pas de développeurs actifs à l'heure actuelle, de nouveaux contributeurs sont invités à se joindre à eux, une documentation abondante étant disponible sur le wiki du projet pour les guider.
...
- L'équipe Android Rust de Google a réécrit le micrologiciel du cadre de virtualisation Android en Rust afin d'améliorer la sécurité et la sûreté des appareils Android, en atténuant efficacement les vulnérabilités souvent liées à des langages peu sûrs pour la mémoire, tels que le C.
...
### [Réactions](https://news.ycombinator.com/item?id=37821994)
...
- La discussion porte sur l'utilisation et la gestion de la mémoire dans les systèmes Linux, les frustrations des utilisateurs se traduisant par des blocages du système en raison d'une mémoire insuffisante et par le comportement douteux de l'outil "Out of Memory" (OOM) killer.
- Les solutions/outils possibles tels que DAMON, la compression de la RAM et ZRAM sont examinés de près afin d'améliorer les performances du système et d'éviter les blocages.
- L'effet de la mise en cache des disques sur les performances du système est débattu, ce qui montre les complexités et les compromis inhérents à la gestion de la mémoire sous Linux.
...
## [Îles de simulation](https://box2d.org/posts/2023/10/simulation-islands/)
...
- L'étude suggère que l'autocorrection des MFR est plus efficace lorsqu'ils peuvent utiliser des sources externes telles que le feedback humain ou une base de connaissances ; sans cela, leurs performances chutent de manière significative.
...
- Les discussions portent sur les limites des modèles de langage (LLM) dans l'émulation de l'intelligence humaine, et sur la question de savoir s'ils comprennent ou raisonnent réellement.
- L'accent est mis sur l'importance de définir des terminologies afin d'éviter le battage des LLM, en soulignant le fossé entre la cognition humaine et l'intelligence artificielle.
...
<head>
  ...
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=John%20Riccitiello%20quitte%20son%20poste%20de%20PDG%20d'Unity&subheading=mardi%2010%20octobre%202023%3A%20R%C3%A9sum%C3%A9%20de%20Hacker%20News" />
</head>
