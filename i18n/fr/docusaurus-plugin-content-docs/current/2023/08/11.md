...
### [Réactions](https://news.ycombinator.com/item?id=37078719)
...
## [L'avenir du projet Vim](https://groups.google.com/g/vim_dev/c/dq9Wu5jqVTw)
...
### [Réactions](https://news.ycombinator.com/item?id=37074452)
...
## [HashiCorp adopte la licence Business Source](https://www.hashicorp.com/blog/hashicorp-adopts-business-source-license)
...
### [Réactions](https://news.ycombinator.com/item?id=37081306)
...
## [Code source pour la réédition de Quake 2](https://github.com/id-Software/quake2-rerelease-dll)
...
### [Réactions](https://news.ycombinator.com/item?id=37082771)
...
## [Les canaux MS Teams ne peuvent pas contenir de noms de dispositifs MS-DOS.](https://learn.microsoft.com/en-us/microsoftteams/limits-specifications-teams)
...
### [Réactions](https://news.ycombinator.com/item?id=37076523)

- La discussion porte sur les limites et les restrictions de Microsoft Teams et SharePoint.
- Les participants discutent des défis posés par la dénomination des fichiers et des fonctions dans les différents systèmes d'exploitation.
- Les frustrations liées aux applications logicielles surchargées sont également prises en compte.

## [Les extensions de bureau de Firefox seront bientôt disponibles pour la prochaine version d'Android](https://blog.mozilla.org/addons/2023/08/10/prepare-your-firefox-desktop-extension-for-the-upcoming-android-release/)

- Mozilla introduit le support d'un écosystème ouvert d'extensions sur Firefox pour Android.
- Les développeurs peuvent optimiser leurs extensions de bureau pour une utilisation mobile sur Firefox pour Android.
- Firefox pour Android sera le seul navigateur Android majeur à prendre en charge cet écosystème d'extensions.

### [Réactions](https://news.ycombinator.com/item?id=37084677)
...
## [Les modèles d'apprentissage automatique mémorisent-ils ou généralisent-ils ?](https://pair.withgoogle.com/explorables/grokking/)
...
### [Réactions](https://news.ycombinator.com/item?id=37076210)
...
## [Mon réseau domestique Overkill](https://blog.networkprofile.org/my-home-network-complete-details-2023/)
...
### [Réactions](https://news.ycombinator.com/item?id=37081789)
...
## [eSignature Beta pour Google Docs et Google Drive](https://workspaceupdates.googleblog.com/2023/08/esignature-google-docs-google-drive.html)
...
### [Réactions](https://news.ycombinator.com/item?id=37079534)
...
- Applite est une application gratuite et open-source pour macOS qui simplifie la gestion des applications tierces.
- Il utilise le gestionnaire de paquets Homebrew et fournit une interface conviviale pour les utilisateurs non techniques.
- Applite est sécurisé, ne suit pas les informations de l'utilisateur et peut être utilisé avec les installations Homebrew existantes.

### [Réactions](https://news.ycombinator.com/item?id=37075730)
...
<head>
  ...
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Vim%20Boss&subheading=vendredi%2011%20ao%C3%BBt%202023:%20R%C3%A9sum%C3%A9%20de%20Hacker%20News" />
</head>
