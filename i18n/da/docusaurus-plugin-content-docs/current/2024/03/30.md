...
## [Kritisk bagdør opdaget i xz/liblzma, der truer SSH-servere](https://www.openwall.com/lists/oss-security/2024/03/29/4)
...
## [Filantrop skaber 'europæisk Yellowstone' i Rumænien](https://english.elpais.com/international/2024-03-29/philanthropist-group-buys-up-large-tracts-of-land-in-romania-to-create-european-yellowstone.html)
...
## [Top-performere siger måske op, hvis nyansatte får mere i løn](https://hbr.org/2024/03/when-new-hires-get-paid-more-top-performers-resign-first)
...
## [Bevarelse af Santa Barbaras digitale historie midt i konkurstruslen](https://www.independent.com/2024/03/29/santa-barbaras-collective-memory-sold-for-kindling/)
...
- Deadspin blev solgt til investorer i online gaming affiliate-industrien, hvilket førte til risici for fællesskabets historie.
- Arbejderne oprettede et kooperativ ved navn Defector på grund af udfordringer med fagforeningsrepræsentation og lokale nyhedssider i Santa Barbara.
- Artiklen handler om at adskille aktiver fra passiver i virksomheder, insiderhandel, prisaftaler og betydningen af at bevare kulturarv gennem arkiver.

## [Apache Guacamole: Få adgang til desktoppen hvor som helst med Clientless Gateway](https://guacamole.apache.org/)
...
- Alternative projekter som BrowserBox, xpra og KasmWeb er blevet diskuteret, og nogle brugere søger Java-uafhængige løsninger, der viser Guacamoles værdi for fjernadgang til skrivebordet.

## [Gødningsudslip i Iowa ødelægger fisk i 60 kilometer lang flodstrækning](https://www.nytimes.com/2024/03/29/us/iowa-spill-fish-kill.html)
...
## [Afdækning af XZ-bagdøren: Risici ved individuelle bidragydere](https://boehs.org/node/everything-i-know-about-the-xz-backdoor)
...
## [At modstå en DDoS-storm med simpelt design og højtydende frameworks](https://tableplus.com/blog/2024/03/how-we-deal-with-ddos.html)
...
## [Maksimering af Raspberry Pi's levetid: Kørsel med skrivebeskyttet rodfilsystem](https://www.dzombak.com/blog/2024/03/Running-a-Raspberry-Pi-with-a-read-only-root-filesystem.html)
...
- Anbefalingerne omfatter industrielle SD-kort, pålidelige strømforsyninger og strategier for SD-kortets levetid for at undgå datakorruption, sammen med brug af overlay-filsystemer som overlayfs med tmpfs til billedproduktion.

## [Udforskning af Werons WebRTC Overlay-netværk](https://github.com/pojntfx/weron)
...
## [Demis Hassabis: I spidsen for Googles AI-satsning](https://www.bigtechnology.com/p/can-demis-hassabis-save-google)
...
## [Afdækning af xz-utils-bagdøren: Hastende sikkerhedsrådgivning](https://gist.github.com/thesamesam/223949d5a074ebc3dce9ee78baad9e27)
...
## [Bekæmpelse af bannerblindhed: Forståelse af brugeradfærd og annonceeffektivitet](https://en.wikipedia.org/wiki/Banner_blindness)
...
<head>
  <meta property="og:title" content="Kritisk bagdør opdaget i xz/liblzma, der truer SSH-servere" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Kritisk%20bagd%C3%B8r%20opdaget%20i%20xz%2Fliblzma%2C%20der%20truer%20SSH-servere&subheading=l%C3%B8rdag%20den%2030.%20marts%202024%3A%20Resum%C3%A9%20af%20Hacker%20News" />
</head>
