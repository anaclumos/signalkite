...
## [Apresentando o Heynote: o bloco de notas perfeito para desenvolvedores](https://heynote.com/)
...
### [Reações](https://news.ycombinator.com/item?id=38733968)
...
## [De Nand a Tetris: construa um sistema de computador do zero com materiais gratuitos de código aberto](https://www.nand2tetris.org)
...
### [Reações](https://news.ycombinator.com/item?id=38735066)

- A passagem abrange vários tópicos em hardware de computador, programação e educação.
- Ele inclui experiências com o projeto "From Nand to Tetris" e recomendações de recursos de aprendizado sobre transistores e circuitos integrados.
- A passagem também discute cursos de ciência da computação, programas e debates sobre ciência da computação teórica.

## [Qual é o tamanho do YouTube? Desafiando os limites com métodos de pesquisa inovadores](https://ethanzuckerman.com/2023/12/22/how-big-is-youtube/)

- O autor explora a dificuldade de determinar o tamanho do YouTube e as limitações dos métodos de pesquisa atuais.
- Eles apresentam uma abordagem exclusiva chamada "drunk dialing" para estimar o número de vídeos do YouTube.
- A pesquisa em andamento usando vídeos aleatórios e a necessidade de publicar dados em plataformas de mídia geradas por usuários são destacadas.
- O autor reconhece as fontes de financiamento e menciona sua experiência com a COVID.

### [Reações](https://news.ycombinator.com/item?id=38739563)
...
## [Vulnerabilidade do WhatsApp permite ataques de phishing por meio de clickjacking](https://00xbyte.github.io/posts/Don%27t-Believe-Your-Eyes-A-WhatsApp-Clickjacking-Vulnerability/)
...
### [Reações](https://news.ycombinator.com/item?id=38732770)
...
## [Biden perdoa indivíduos por crimes relacionados à maconha para remover barreiras](https://www.whitehouse.gov/briefing-room/presidential-actions/2023/12/22/a-proclamation-on-granting-pardon-for-the-offense-of-simple-possession-of-marijuana-attempted-simple-possession-of-marijuana-or-use-of-marijuana/)
...
### [Reações](https://news.ycombinator.com/item?id=38736919)
...
## [O Google se esforça para conter o ataque de spam em andamento](https://www.searchenginejournal.com/google-search-overwhelmed-by-massive-spam-attack/504527/)
...
### [Reações](https://news.ycombinator.com/item?id=38738619)
...
## [Atualização do aplicativo Bluesky: Acesse publicações, perfis e pesquisa de usuários sem fazer login](https://bsky.app/profile/bsky.app/post/3kh5rbndrjd2x)
...
### [Reações](https://news.ycombinator.com/item?id=38739130)
...
## [In the Long Run: Reflections on Parenthood, Genetic Enhancements, and Self-Navigation (Reflexões sobre paternidade, aprimoramentos genéticos e autonavegação)](https://www.astralcodexten.com/p/in-the-long-run-were-all-dad)
...
### [Reações](https://news.ycombinator.com/item?id=38733440)
...
## [Teste de WebGPU agora aberto no Safari Technology Preview](https://webkit.org/blog/14879/webgpu-now-available-for-testing-in-safari-technology-preview/)
...
### [Reações](https://news.ycombinator.com/item?id=38737028)
...
## [Atualização do NewPipe 0.26.0: Correções para streams do YouTube, acesso aprimorado ao conteúdo e recursos aprimorados](https://github.com/TeamNewPipe/NewPipe/releases/tag/v0.26.0)
...
### [Reações](https://news.ycombinator.com/item?id=38732781)

- O NewPipe é um cliente alternativo do YouTube para Android que oferece recursos como reprodução em segundo plano, que os usuários apreciam muito.
- Alguns usuários enfrentam problemas com a reprodução automática ao usar o NewPipe, o que pode ser uma desvantagem para alguns.
- Infelizmente, o NewPipe não está disponível para usuários do iOS, pois é independente do aplicativo oficial do YouTube.

## [Criando um piercing industrial de LED: Uma história de sucesso DIY](https://mitxela.com/projects/scaffold)
...
### [Reações](https://news.ycombinator.com/item?id=38734164)
...
## [Impulsionando os LLMs: Estratégias para aumentar a velocidade e a eficiência](https://vgel.me/posts/faster-inference/)
...
### [Reações](https://news.ycombinator.com/item?id=38733384)
...
## [SymbOS: o sistema operacional multitarefa de 8 bits para hardware Z80 e além](http://www.symbos.de/)

- O SymbOS é um sistema operacional multitarefa de 8 bits disponível para vários sistemas de computadores retrô.
- Ele oferece uma ampla variedade de aplicativos, utilitários, multimídia, jogos e widgets de área de trabalho.
- As atualizações recentes incluem o lançamento do SymbOS NC, que adiciona suporte a dados compactados e melhorias em vários aplicativos.

### [Reações](https://news.ycombinator.com/item?id=38736054)
...
<head>
  <meta property="og:title" content="Apresentando o Heynote: o bloco de notas perfeito para desenvolvedores" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Apresentando%20o%20Heynote%3A%20o%20bloco%20de%20notas%20perfeito%20para%20desenvolvedores&subheading=s%C3%A1bado%2C%2023%20de%20dezembro%20de%202023%3A%20Resumo%20do%20Hacker%20News" />
</head>
