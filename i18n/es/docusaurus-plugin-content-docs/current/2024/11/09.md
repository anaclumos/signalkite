...
## [Delta: Un paginador con resaltado de sintaxis para la salida de Git, diff, grep y blame](https://github.com/dandavison/delta)
...
### [Reacciones](https://news.ycombinator.com/item?id=42091365)
...
## [Dejé Google para trabajar por mi cuenta (2018)](https://mtlynch.io/why-i-quit-google/)
...
### [Reacciones](https://news.ycombinator.com/item?id=42090430)
...
## [Es legal que la policía use el engaño en los interrogatorios. Algunos quieren que eso termine](https://text.npr.org/nx-s1-4974964)
...
### [Reacciones](https://news.ycombinator.com/item?id=42091423)
...
## [Mergiraf: un controlador de fusión consciente de la sintaxis para Git](https://mergiraf.org/)
...
### [Reacciones](https://news.ycombinator.com/item?id=42093756)
...
## [Claude AI procesará datos gubernamentales secretos a través de un nuevo acuerdo con Palantir](https://arstechnica.com/ai/2024/11/safe-ai-champ-anthropic-teams-up-with-defense-giant-palantir-in-new-deal/)
...
### [Reacciones](https://news.ycombinator.com/item?id=42091043)
...
## [La científica trató su propio cáncer con virus que cultivó en el laboratorio](https://www.nature.com/articles/d41586-024-03647-0)
...
### [Reacciones](https://news.ycombinator.com/item?id=42094573)
...
## [HTML a Markdown: convierte sitios web completos a Markdown con Golang/CLI](https://github.com/JohannesKaufmann/html-to-markdown)
...
### [Reacciones](https://news.ycombinator.com/item?id=42093511)
...
## [Mis notas sobre notas de matemáticas de Apple](https://mlajtos.mu/posts/new-kind-of-paper-5)
...
### [Reacciones](https://news.ycombinator.com/item?id=42090633)
...
## [Renderizado de Texto sin Textura](https://poniesandlight.co.uk/reflect/debug_print_text/)
...
### [Reacciones](https://news.ycombinator.com/item?id=42093037)
...
## [¿Qué es un ingeniero de planta?](https://nishtahir.com/what-is-a-staff-engineer/)
...
### [Reacciones](https://news.ycombinator.com/item?id=42090771)
...
## [SVDQuant: La cuantización de 4 bits potencia 12B Flux en una GPU 4090 de 16GB con un aumento de velocidad de 3x](https://hanlab.mit.edu/blog/svdquant)
...
### [Reacciones](https://news.ycombinator.com/item?id=42093112)
...
## [Los recuerdos no solo están en el cerebro, según un estudio de células humanas](https://medicalxpress.com/news/2024-11-memories-brain-human-cell.html)

### [Reacciones](https://news.ycombinator.com/item?id=42094427)

- Un estudio propone que los recuerdos pueden no estar limitados al cerebro, sugiriendo una posible transmisión de información hereditaria más allá del ADN.
- Esta investigación desafía la visión tradicional exclusiva de las neuronas sobre la formación de la memoria, indicando que otros tipos de células también podrían codificar información.
- La investigación plantea preguntas intrigantes sobre fenómenos como los instintos de los pájaros cantores y los receptores de trasplantes de corazón que experimentan nuevos recuerdos, aunque estas afirmaciones aún se debaten.

## [El dinero nunca fue el objetivo final – mrdoob – creador de threejs](https://twitter.com/mrdoob/status/1854662365163536613)

- El creador desarrolló una alternativa gratuita en HTML5/WebGL a Adobe Flash, impulsado por el deseo de reducir la dependencia de la tecnología Flash.
- La fase de desarrollo implicó sacrificios personales significativos, lo que resalta la dedicación del creador al proyecto.
- La motivación detrás del proyecto no fue el beneficio financiero, sino más bien un compromiso con proporcionar una solución más accesible y moderna.

### [Reacciones](https://news.ycombinator.com/item?id=42093795)

- Mrdoob, el creador de three.js, inicialmente lo desarrolló como un proyecto de pasión, que más tarde se convirtió en parte de su trabajo a tiempo completo en Google.
- Muchos proyectos de código abierto enfrentan desafíos financieros, pero three.js se ha mantenido gracias al apoyo de Google y las donaciones.
- Three.js ha influido significativamente en los gráficos 3D en navegadores, destacando el impacto de las contribuciones dedicadas de código abierto.

## [SQLite no realiza sumas de verificación](https://avi.im/blag/2024/sqlite-bit-flip/)

- SQLite no realiza sumas de verificación por defecto, lo que significa que no puede detectar la corrupción del disco, dejándolo vulnerable a problemas de datos incluso por un solo cambio de bit.
- Aunque SQLite utiliza sumas de verificación para los marcos de registro de escritura anticipada (WAL), ignora los marcos corruptos sin generar errores, lo que podría llevar a una corrupción de datos no detectada.
- La capa de compatibilidad VFS de Checksum se puede utilizar para añadir funcionalidad de suma de verificación, pero requiere un valor de bytes de reserva de exactamente 8, lo que limita su compatibilidad con ciertas extensiones.

### [Reacciones](https://news.ycombinator.com/item?id=42094663)

- SQLite, al igual que muchas bases de datos como PostgreSQL, no realiza sumas de verificación por defecto, las cuales se utilizan para garantizar la integridad de los datos.
- Si bien las bases de datos como Oracle y SQL Server tienen sumas de verificación habilitadas por defecto, los usuarios de SQLite deben ser conscientes de esta limitación, especialmente para datos críticos.
- La discusión enfatiza la importancia de comprender las características de las bases de datos y el papel de los checksums en el mantenimiento de la integridad de los datos.

<head>
  <meta property="og:title" content="Delta: Un paginador con resaltado de sintaxis para la salida de Git, diff, grep y blame" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Delta%3A%20Un%20paginador%20con%20resaltado%20de%20sintaxis%20para%20la%20salida%20de%20Git%2C%20diff%2C%20grep%20y%20blame&subheading=s%C3%A1bado%2C%209%20de%20noviembre%20de%202024%3A%20Resumen%20de%20Hacker%20News" />
</head>
