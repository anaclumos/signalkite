...
### [反应](https://news.ycombinator.com/item?id=41526288)
...
### [反应](https://news.ycombinator.com/item?id=41527991)
...
- “Notepat”是Jeffrey Scudder的一个数字艺术项目，可以通过网站aesthetic.computer访问，展示了一个复古计算环境和用于创作数字艺术的独特工具。
