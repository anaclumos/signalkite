...
## [Node.js lägger till experimentellt stöd för TypeScript](https://github.com/nodejs/node/pull/53725)
...
## [Varje företag bör ägas av sina anställda](https://www.elysian.press/p/employee-ownership)
...
## [Undersöker korrupta Winamp-skins](https://jordaneldredge.com/notes/corrupted-skins/)
...
## [AI löser problem från den internationella matematikolympiaden på silvermedaljnivå](https://deepmind.google/discover/blog/ai-solves-imo-problems-at-silver-medal-level/)
...
## [Apple Maps på webben lanseras i beta](https://www.apple.com/newsroom/2024/07/apple-maps-on-the-web-launches-in-beta/)
...
## [Dungeons and Dragons lärde mig hur man skriver alt-text](https://ericwbailey.website/published/dungeons-and-dragons-taught-me-how-to-write-alt-text/)
...
## [CrowdStrike kommer att vara ansvarigt för skadestånd i Frankrike, baserat på OVH-prejudikatet](https://thehftguy.com/2024/07/25/crowdstrike-will-be-liable-for-damages-in-france-based-on-the-ovh-precedent/)
...
## [EU-parlamentsledamot drabbad av israelisk Candiru-spyware](https://twitter.com/moo9000/status/1816352054425829420)
...
## [En multimodal dataset med en biljon token](https://github.com/mlfoundations/MINT-1T)
...
## [Omvänd ingenjörskonst för alla](https://0xinfection.github.io/reversing/)
...
## [X designar om vattenpistol-emoji till en skjutvapen](https://blog.emojipedia.org/x-redesigns-water-pistol-emoji-back-to-a-firearm/)
...
## [Min favoritalgoritm: Medianfinnande i linjär tid (2018)](https://rcoh.me/posts/linear-time-median-finding/)
...
## [OpenAI tillkännager SearchGPT](https://chatgpt.com/search)
...
## [Genererar sudokun för nöje och ingen vinst](https://tn1ck.com/blog/how-to-generate-sudokus)
...
## [Google Sök: Roboto Mono](https://www.google.com/search?q=roboto+mono+font)
...
<head>
  <meta property="og:title" content="Node.js lägger till experimentellt stöd för TypeScript" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Node.js%20l%C3%A4gger%20till%20experimentellt%20st%C3%B6d%20f%C3%B6r%20TypeScript&subheading=torsdag%2025%20juli%202024%3A%20Sammanfattning%20av%20Hacker%20News" />
</head>
