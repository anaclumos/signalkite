...
## [Titta på TV från 90-talet och tidigare](https://my90stv.com/)
...
## [Sci-Hub-grundaren får EFF-utmärkelse för att ha gett tillgång till vetenskaplig kunskap](https://torrentfreak.com/sci-hubs-alexandra-elbakyan-receives-eff-award-for-providing-access-to-scientific-knowledge-230728/)
...
## [Worldcoin är inte så illa som det låter: Det är värre](https://blockworks.co/news/worldcoin-privacy-concerns)
...
## [Storbritanniens regering är nära att urholka krypteringen i hela världen](https://www.eff.org/deeplinks/2023/07/uk-government-very-close-eroding-encryption-worldwide)
...
## [Brist på lekmöjligheter är en viktig orsak till den psykiska krisen bland tonåringar](https://jonathanhaidt.substack.com/p/the-play-deficit)
...
## [Kalifornien försöker tysta Stanford-forskare som fick data för att studera utbildning](https://edsource.org/2023/california-moves-to-silence-stanford-researchers-who-got-state-data-to-study-education-issues/694920)
...
## [Varför är DNS fortfarande svårt att lära sig?](https://jvns.ca/blog/2023/07/28/why-is-dns-still-hard-to-learn/)
...
## ["Web Environment Integrity" är ett angrepp på det fria Internet](https://www.fsf.org/blogs/community/web-environment-integrity-is-an-all-out-attack-on-the-free-internet)
...
## [No-GIL-läge på väg för Python](https://lwn.net/Articles/939568/)
