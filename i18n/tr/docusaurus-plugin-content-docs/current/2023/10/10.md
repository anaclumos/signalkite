...
## [Google, 398 milyon rps'nin üzerine çıkarak bugüne kadarki en büyük DDoS saldırısını hafifletti](https://cloud.google.com/blog/products/identity-security/google-cloud-mitigated-largest-ddos-attack-peaking-above-398-million-rps/)
...
## [Ortaçağ merdivenleri savunmacının avantajı için saat yönünde inşa edilmemiştir](https://fakehistoryhunter.net/2023/10/09/medieval-staircases-were-not-built-going-clockwise-for-the-defenders-advantage/)
...
- Bu yanlış kanı 19. yüzyılda Sir Theodore Andrea Cook tarafından ortaya atılan bir teoriden kaynaklanmış olabilir, ancak ortaçağ savaş anlayışı ve spiral merdivenlerde savaşmanın pratikliği ile uyuşmuyor.
...
- Deney, adil bir madeni paranın ilk yüzü rastgele belirlenerek çevrildiğinde, yazı ya da tura gelme şansının eşit olduğunu da doğruladı.
...
- DSLinux projesi, Linux işletim sistemini Nintendo DS ve DS Lite'a taşıyarak bir kilometre taşına ulaştı ve bazı NDS emülatörleriyle uyumlu hale geldi.
...
### [Tepkiler](https://news.ycombinator.com/item?id=37823377)
...
- Makale, sofra tuzuyla evde piramit tuz kristalleri oluşturmaya dair ayrıntılı bir eğitim sunmakta ve yazarın tuz çözeltisine şap eklemenin daha saf bir tuz tadı verdiğine dair bulgularını göstermektedir.
...
## [Linux RAM'imi yedi (2009)](https://www.linuxatemyram.com/)


### [Tepkiler](https://news.ycombinator.com/item?id=37822927)

- Tartışma, Linux sistemlerinde bellek kullanımı ve yönetimi etrafında dönüyor ve kullanıcı hayal kırıklıkları, düşük bellek nedeniyle sistem kilitlenmelerine ve Bellek Dışı (OOM) katilinin şüpheli davranışlarına işaret ediyor.
- Sistem performansını artırmak ve kilitlenmeleri önlemek için DAMON, RAM sıkıştırma ve ZRAM gibi olası çözümler/araçlar incelenmiştir.
- Disk önbelleğe almanın sistem performansı üzerindeki etkisi, Linux bellek yönetiminin doğasında bulunan karmaşıklıkları ve ödünleşimleri göstererek tartışılmaktadır.
...
- Girişim, sohbet kontrolünün yanlış sonuçlar doğurduğunu, soruşturma başarılarını engelleyebilecek yetkilileri zorladığını, Temel Haklar Şartı'nı ihlal ettiğini ve şifreleme altyapısına zarar verdiğini iddia ediyor.
- Çocukların korunması için başka yollar öneriyor, yerel AP üyelerine ulaşarak anlaşmazlıkları dile getirmeyi teşvik ediyor, etkili iletişim için yapay zeka tarafından oluşturulan e-posta şablonları sunuyor ve kanun yapıcılar üzerinde daha fazla baskı uygulamak için bir dilekçe imzalamayı teşvik ediyorlar.
...
- Bu makale, özellikle Box2D'ye odaklanarak, fizik motorlarında ada yönetiminin öneminin altını çizmektedir.
...
- Ayrıca, Box2D'nin yeniden dirilişiyle ilgili aktif gelişim ve heyecanı vurgulayarak, birlik bulma ve yayılma hızı yoluyla nedensellik sınırlamaları için deterministik bir paralel algoritma üzerine tartışmalar da var.
...
- Google DeepMind ve Illinois Üniversitesi tarafından yakın zamanda yapılan bir çalışma, büyük dil modellerinde (LLM'ler) kendi kendini düzeltme konusundaki mevcut anlayışa meydan okuyarak, bu modellerin genellikle harici geri bildirim olmadan cevaplarını düzeltmekte zorlandıklarını ortaya koydu.
...
<head>
  ...
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=John%20Riccitiello%20Unity%20CEO'lu%C4%9Fundan%20istifa%20etti&subheading=10%20Ekim%202023%20Sal%C4%B1%3A%20Hacker%20Haber%20%C3%96zeti" />
</head>
