...
- SEDaily Podcast 特別節目中，Alyssa Rosenzweig 討論了透過 Asahi Linux 專案將 Linux 移植到蘋果的 ARM 架構晶片(稱為 Apple Silicon)的努力。
...
### [評論](https://news.ycombinator.com/item?id=42022796)
