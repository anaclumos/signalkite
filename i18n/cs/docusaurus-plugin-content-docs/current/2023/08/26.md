...
## [OpenTF oznamuje rozvětvení Terraformu](https://opentf.org/announcement)
...
### [Reakce](https://news.ycombinator.com/item?id=37262440)
...
## [Factorio: Vesmírný věk](https://factorio.com/blog/post/fff-373)

- Hra Factorio dostává nové rozšíření s názvem Factorio: Space Age, které pokračuje v cestě hráče po dosažení vesmíru.
- Rozšíření přinese nové světy, meziplanetární vesmírné platformy a logistiku, které poskytnou jedinečné výzvy a zdroje.
- Datum vydání rozšíření je plánováno přibližně na rok a bude obsahovat vylepšení celé hry, například lepší ovládání vlaků a tvorbu plánů.

### [Reakce](https://news.ycombinator.com/item?id=37260637)
...
## [Překonání GPT-4 na HumanEval s vyladěným CodeLlama-34B](https://www.phind.com/blog/code-llama-beats-gpt4)

- Tým Phind vycvičil modely CodeLlama na souboru dat a dosáhl působivých výsledků v testu HumanEval.
- Modely byly zveřejněny na webu Huggingface za účelem ověření a podpory komunity open-source.
- Byly zmíněny výsledky modelů pass@1 a srovnání s výkonem GPT-4.

### [Reakce](https://news.ycombinator.com/item?id=37267597)
...
## [Škrábání webu pro mě, ale ne pro tebe](https://blog.ericgoldman.org/archives/2023/08/web-scraping-for-me-but-not-for-thee-guest-blog-post.htm)
...
### [Reakce](https://news.ycombinator.com/item?id=37264676)
...
## [Vzdát se cestovního snu pouze o iPadu](https://sixcolors.com/post/2023/08/why-i-gave-up-on-the-ipad-only-dream/)
...
### [Reakce](https://news.ycombinator.com/item?id=37266957)

- Článek se zabývá výhodami a nevýhodami používání iPadů a dalších zařízení při činnostech, jako je cestování, psaní poznámek a konzumace médií.
- Uživatelé mají různé názory na pohodlí a přenosnost iPadů ve srovnání s notebooky a jinými tablety.
- Diskutuje se například o kompatibilitě softwaru, omezeních zařízení a přání konvertibilních zařízení.

## [Válka EU proti behaviorální reklamě](https://thisisunpacked.substack.com/p/the-eu-war-on-behavioral-advertising)
...
### [Reakce](https://news.ycombinator.com/item?id=37263322)
...
## [Uniklý zdrojový kód hry Wipeout vede k téměř kompletnímu přepsání a remasteru](https://arstechnica.com/gaming/2023/08/developer-rewrites-original-wipeout-from-abysmal-leaked-windows-source/)
...
### [Reakce](https://news.ycombinator.com/item?id=37262258)
...
## [HelloSystem: Grafický operační systém postavený na FreeBSD](https://hellosystem.github.io/docs/)

- helloSystem je uživatelsky přívětivý desktopový systém založený na FreeBSD se zaměřením na jednoduchost a použitelnost pro tvůrce.
- Je navržen tak, aby vyhovoval uživatelům Maců, kteří chtějí přejít na jiný operační systém.
- Další podrobnosti a informace o helloSystem najdete na stránce GitHub.

### [Reakce](https://news.ycombinator.com/item?id=37262857)

- HelloSystem je grafický operační systém postavený na FreeBSD, který je navržen tak, aby byl kompatibilní s aplikacemi pro macOS a FreeBSD.
- Diskuse se zabývá různými pohledy na stabilitu, design, uživatelské zkušenosti a výhody různých operačních systémů.
- Zmiňuje se o podobnostech mezi HelloSystem a RISC OS a také o možných obavách ohledně ochranné známky související s názvem operačního systému.

## [Webové stránky College Board sdílejí průměrné známky a výsledky testů SAT s TikTokem a Facebookem.](https://gizmodo.com/sat-college-board-tells-facebook-tiktok-your-scores-gpa-1850768077)
...
### [Reakce](https://news.ycombinator.com/item?id=37260553)
...
## [Ověřování e-mailu: Příručka pro vývojáře](https://resend.com/blog/email-authentication-a-developers-guide)

- Ověřování e-mailů je zásadní pro úspěšné doručení e-mailů a pro zabránění tomu, aby e-maily skončily ve složkách nevyžádané pošty.
- SPF, DKIM, DMARC a BIMI jsou klíčové ověřovací protokoly, které určují legitimitu odesílatelů e-mailů a zvyšují reputaci domény.
- Funkce Resend nabízí automatické zpracování ověření SPF a DKIM pro lepší doručitelnost e-mailů.

### [Reakce](https://news.ycombinator.com/item?id=37263708)
...
<head>
  <meta property="og:title" content="OpenTF oznamuje rozvětvení Terraformu" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=OpenTF%20oznamuje%20rozv%C4%9Btven%C3%AD%20Terraformu&subheading=sobota%2026.%20srpna%202023%3A%20Hacker%20News%20Shrnut%C3%AD" />
</head>
