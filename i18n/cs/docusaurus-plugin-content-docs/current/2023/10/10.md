...
- Tématem je také budoucnost Unity, jeho vztah s nezávislými vývojáři a vyhlídky na to, že se do popředí dostanou alternativní herní enginy.
...
- Společnost Google úspěšně zmařila dosud největší útok DDoS (Distributed Denial-of-Service), který dosáhl rychlosti 398 milionů požadavků za sekundu (rps), a to pomocí nové techniky nazvané HTTP/2 Rapid Reset.
- Při obraně, která byla zaměřena na významné poskytovatele infrastruktury, včetně služeb a infrastruktury společnosti Google, hrála významnou roli globální infrastruktura společnosti Google pro vyrovnávání zátěže a zmírňování DDoS, která navíc spolupracovala s partnery z odvětví, aby bylo možné komplexně pochopit a vyvinout protiopatření.
...
- Článek se zabývá nedostatečnou podporou paměti ECC (Error Correcting Code) RAM ve stolních procesorech AMD (Advanced Micro Devices) Ryzen 7000 (Central Processing Units).
...
### [Reakce](https://news.ycombinator.com/item?id=37822774)
...
- Rozhovor se týká například obléhací taktiky, hradní architektury a historických událostí. Je však patrný nedostatek nezvratných důkazů a různých pohledů, které by podporovaly ten či onen názor.
...
- Článek se zabývá obtížemi, které se vyskytují při streamování videa, a podrobně popisuje, jak strukturovat infrastrukturu, aby bylo možné efektivně zvládat zátěž.
...
- Tým Android Rust společnosti Google přepsal firmware pro virtualizační rámec Androidu v jazyce Rust, aby zvýšil bezpečnost a zabezpečení zařízení se systémem Android a účinně tak zmírnil zranitelnosti, které jsou často spojeny s jazyky, jež nejsou bezpečné pro paměť, jako je například jazyk C.
- Tým aktivně přispíval komunitě Rust opravami chyb, vylepšováním stávajících a vytvářením nových beden, přičemž odhalil přetrvávající problémy se sdílenou pamětí, nezpracovanými ukazateli a nedostatkem nástrojů pro zapouzdření a abstrakce pro kritické sekce.
...
### [Reakce](https://news.ycombinator.com/item?id=37821821)
...
- Diskuse se točí kolem využití paměti a její správy v systémech Linux, přičemž uživatelé poukazují na zablokování systému kvůli nedostatku paměti a na sporné chování nástroje Out of Memory Killer (OOM).
- Zkoumají se možná řešení/nástroje, jako je DAMON, komprese RAM a ZRAM, aby se zvýšil výkon systému a zabránilo se jeho zablokování.
- Diskutuje se o vlivu diskové mezipaměti na výkon systému, což ukazuje složitost a kompromisy, které jsou vlastní správě paměti v systému Linux.
...
### [Reakce](https://news.ycombinator.com/item?id=37826775)
...
- Je zdůrazněna důležitost definování terminologie, aby se předešlo humbukům kolem LLM, a zdůrazněna propast mezi lidským poznáním a umělou inteligencí.
...
<head>
  ...
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=John%20Riccitiello%20odstupuje%20z%20funkce%20gener%C3%A1ln%C3%ADho%20%C5%99editele%20spole%C4%8Dnosti%20Unity&subheading=%C3%BAter%C3%BD%2010.%20%C5%99%C3%ADjna%202023%3A%20Hacker%20News%20Shrnut%C3%AD" />
</head>
