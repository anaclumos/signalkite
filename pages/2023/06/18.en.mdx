...
### [London Underground Dot Matrix Typeface](https://github.com/petykowski/London-Underground-Dot-Matrix-Typeface)- The London TFL Dot Matrix Typeface is a collection of fonts that mimic the style of the fonts used in the London Underground's arrival boards and announcement boards.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36367667)- A user reminisces about creating their own video game engine in the 90s and manually copying fonts from Lucasfilm games, similar to the London Underground Dot Matrix Typeface.
...
### [Update: U+237C ⍼ &Angzarr;](https://ionathan.ch/2023/06/06/angarr.html)- This post is an investigation into the symbol U+237C ⍼ RIGHT ANGLE WITH DOWNWARDS ZIGZAG ARROW.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36369553)- The website http://xml.coverpages.org hosts pre-2000 material related to ISO 8879 (SGML) and XML.
...
### [Bullshit Jobs (2018)](https://theanarchistlibrary.org/library/david-graeber-bullshit-jobs)- The phenomenon of "bullshit jobs" refers to forms of employment that are considered pointless, unnecessary, or even pernicious by the person doing the job.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36373190)- The book "Bullshit Jobs" explores the concept of jobs that are seen as pointless, unnecessary, or pernicious by the employees themselves.
...
### [I don't need your query language](https://antonz.org/fancy-ql/)- Every year, new general-purpose database engines are released with new query languages.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36369018)- SQL has limitations when it comes to querying heterogeneous databases and dealing with multiplicity mismatch in JOINs.
...
### [GB Studio: Drag and drop retro game creator for GameBoy](https://www.gbstudio.dev/)- GB Studio is a drag and drop retro game creator for the GameBoy handheld video game system.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36372284)- GB Studio is a game engine that allows users to create retro games for the GameBoy
...
### [People can be convinced they committed a crime that never happened (2015)](https://www.psychologicalscience.org/news/releases/people-can-be-convinced-they-committed-a-crime-they-dont-remember.html)- Research shows that suspects can be convinced they committed crimes that they didn't actually commit
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36367147)- Researchers have found that false memories can be implanted, leading people to believe they committed a crime that never happened.
...
### Why does Apple refuse to add window snapping to macOS?- Users are questioning why Apple has not added a feature called "window snapping" to their macOS operating system.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36368990)- Users are frustrated with the absence of a built-in window snapping feature in macOS.
...
### [The Secret Sauce behind 100K context window in LLMs: all tricks in one place](https://blog.gopenai.com/how-to-speed-up-llms-and-use-100k-context-window-all-tricks-in-one-place-ffd40577b4c)- Large Language Models (LLMs) can now process an extremely large context window, up to 100K input tokens, during training and inference.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36374936)- The article discusses the techniques used to extend the context window in LLMs and make them work effectively.
...
### [Review of Hetzner ARM64 servers and experience of WebP cloud services on them](https://blog.webp.se/hetzner-arm64-en/)- Hetzner's ARM64 servers perform well in webP conversion speed, only 8% slower than their AMD64 counterparts, with a 14% price difference and double the amount of RAM.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36368586)- The article discusses the review of Hetzner ARM64 servers and the experience of using WebP cloud services on them.
...
### [Merging bcachefs](https://lwn.net/SubscriberLink/934692/5046d466490d9220/)- The bcachefs filesystem was discussed at the 2023 Linux Storage, Filesystem, Memory-Management and BPF Summit, and the process for merging it into the mainline kernel seems closer than ever.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36366002)- Bcachefs is a file system that is in a good position to be merged into the Linux kernel.
