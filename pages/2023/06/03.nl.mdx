...
### [3 juni 2023 [Brute.Fail: Bekijk hoe brute krachtaanvallen mislukken in realtime](https://brute.fail/)- Brute.Fail toont real-time voorbeelden van aanvallers die proberen in te breken op servers door gebruikersnamen en wachtwoorden te raden.
...
#### [Reacties uit de branche](http://news.ycombinator.com/item?id=36169954)- Het gebruik van fail2ban kan serverbronnen sparen door reacties op brute force aanvallen te stoppen, maar kan ze niet voorkomen.
...
### [Californië gaf $17B uit aan dakloosheid - het werkt niet](https://www.wsj.com/articles/california-homeless-population-oakland-wood-street-encampment-78d42cc3)- Californië heeft 17 miljard dollar uitgegeven aan dakloosheid, maar het probleem blijft bestaan.
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36162154)- Californië heeft 17 miljard dollar uitgegeven aan dakloosheid, maar het werkt niet. De "housing first" strategie wordt niet effectief toegepast in San Francisco, ondanks het succes in Finland.
...
### [Reddit-apps van derden worden verpletterd door prijsverhogingen](https://kotaku.com/reddit-third-party-3rd-apps-pricing-crush-ios-android-1850493992)- Apps van derden, zoals Apollo en Infinity, worden uit de markt geprijsd door nieuwe kosten die Reddit in rekening brengt voor toegang tot zijn API.
...
#### [Reacties uit de branche](http://news.ycombinator.com/item?id=36162235)- Reddit's apps van derden hebben te maken met prijsverhogingen voor API-toegang, waardoor bezorgdheid ontstaat over de relatie tussen Reddit en haar gebruikers.
...
### [Stralingsbestendige Quine (2014)](https://github.com/mame/radiation-hardened-quine)- Stralingsbestendige Quine is een zelfprintend programma geschreven in Ruby dat zelfs werkt als je een karakter uit de code verwijdert.
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36162164)- Een quine die bestand is tegen straling en die het verwijderen van één karakter kan verdragen zonder de uitvoerbaarheid te beïnvloeden, is gedeeld door een hacker op Hacker News.
...
### [Hoe je mooie wegenkaarten maakt met R en OpenStreetMap](https://www.andrewheiss.com/blog/2023/06/01/geocoding-routing-openstreetmap-r/)- Andrew Heiss legt uit hoe hij OpenStreetMap, R, `sf` en `ggplot2` heeft gebruikt om wegenkaarten te maken.
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36159864)- Commenters bespreken historische en geologische informatie over regio's langs de road trip route- Debat over het gebruik van R versus Python voor het maken van kaarten- Sommige respondenten delen hun eigen ervaringen met het plannen van reizen en stellen tools of bibliotheken voor om kaarten te maken

### [27 jaar later en de Psion 3a is nog steeds geweldig (2020)](https://mcgst.com/2020/12/01/27-years-later-and-the-psion-3a-is-still-wonderful/)- Psion 3a, een PDA die in 1993 werd uitgebracht, is na 27 jaar nog steeds functioneel en heeft veel innovatieve functies.
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36162265)- Tech enthousiastelingen bespreken de Psion 3a en uiten nostalgie voor zijn vormfactor en gebruiksvriendelijke interface.
...
### [Scan iPhone-back-ups op sporen van compromittering door "Operatie Driehoeksmeting"](https://github.com/KasperskyLab/triangle_check)- Een nieuw script met de naam Triangle Check kan iTunes-back-ups scannen op sporen van compromittering door "Operatie Driehoeksmeting".
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36164340)- Kaspersky Lab heeft "Operation Triangulation" uitgebracht, een tool die iPhone-back-ups kan scannen op compromittering.
...
### [Het is niet verkeerd dat "🤦🏼♂".length == 7 (2019)](https://hsivonen.fi/string-length/)- Het artikel onderzoekt de verschillende manieren waarop programmeertalen tekenreekslengte definiëren en meten, specifiek als het gaat om Unicode en emoji's.
...
#### [Reacties vanuit de industrie](http://news.ycombinator.com/item?id=36159443)- Het artikel bespreekt de dubbelzinnigheid van het "lengte"-attribuut voor tekenreeksen en stelt voor om het te vervangen door preciezere descriptoren.
...
### [Hij maakte lineaire algebra leuk](https://news.mit.edu/2023/gilbert-strang-made-linear-algebra-fun-0531)- Professor Gil Strang is na 66 van zijn 88 jaar bij MIT met pensioen gegaan. Hij onderwees lineaire algebra aan duizenden studenten aan MIT, wat uiteindelijk uitgroeide tot een cursus voor een derde van de studentenpopulatie van het instituut, en hij deelde zijn cursusmateriaal op MIT OCW.
...
#### [Reacties uit de industrie](http://news.ycombinator.com/item?id=36168068)- Gilbert Strang, een beroemde wiskundige en expert op het gebied van lineaire algebra, ging met pensioen na een onderwijscarrière van 61 jaar.
