...
### [Deepmind Alphadev: Faster sorting algorithms discovered using deep RL](https://www.nature.com/articles/s41586-023-06004-9)- AlphaDev is an AI program created by researchers at DeepMind that uses deep reinforcement learning to discover and generate efficient sorting algorithms from scratch.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36228125)- Deepmind's AlphaDev team discovered new sorting algorithms using deep reinforcement learning that improved the LLVM libc++ sorting library by up to 70% for short sequences and 1.7% for larger ones.
...
### [uBlock Origin 1.50.0](https://github.com/gorhill/uBlock/releases/tag/1.50.0)- uBlock Origin 1.50.0 has been released with various fixes and changes- The update adds new features like the ability to remove attributes and injecting scriptlets in MAIN or ISOLATED world- It's available for Firefox, Chromium, Edge, and Opera, with install and review pending for some platforms.

#### [Industry Reactions](http://news.ycombinator.com/item?id=36227411)- Comparison between uBlock and uBlock Origin- uBlock Origin is recommended for being authentic and open-source- Addon updates can lead to adware/malware extensions being resold

### [Reddit's Recently Announced API Changes, and the future of /r/blind](https://old.reddit.com/r/Blind/comments/13zr8h2/reddits_recently_announced_api_changes_and_the/)- The r/blind community is protesting Reddit's recent API pricing changes that will affect third-party apps like those used by visually impaired moderators and users.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36231016)- Reddit is facing criticism for its lack of accessibility for disabled users, with concerns raised about the lack of respect for volunteers and long-standing moderators.
...
#### [Royal Navy says quantum navigation test a success](https://thequantuminsider.com/2023/06/06/royal-navy-says-quantum-navigation-test-a-success/) [Industry Reactions](http://news.ycombinator.com/item?id=36222625)- The Royal Navy has successfully tested quantum navigation using variations in the gravitational constant g, potentially improving navigation accuracy and reducing the need for submarines to surface for GPS.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36233068)- Avast's acquisition of "I don't care about cookies" has caused users to seek alternative options due to concerns over data privacy policies and ownership changes.
...
### [Apple removes $99 dev account requirement for first iOS 17 and macOS 14 betas](https://arstechnica.com/gadgets/2023/06/how-to-install-ios-17-and-macos-14-developer-betas-now-that-anyone-can-do-it/)- Apple has removed the $99 developer account requirement for access to first iOS 17 and macOS 14 betas.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36230839)- Apple has removed the $99 dev account requirement for submitting applications to its App Store for beta testing on iOS 17 and macOS 14.
...
### [DirectX 12 Support on macOS](https://twitter.com/andytizer/status/1666131239575728130)- This text does not contain any content related to cutting-edge tech news or information on DirectX 12 support on macOS.

- This website is best experienced by visiting the website directly.
- Please visit the website to read the article.

#### [Industry Reactions](http://news.ycombinator.com/item?id=36222266)- Apple has introduced DirectX 12 support on macOS, allowing for translation to the Metal API rather than relying on Vulkan translation.
...
### [SEC granted emergency restraining order to freeze, repatriate Binance.US assets](https://www.kitco.com/news/2023-06-07/SEC-granted-emergency-restraining-order-to-freeze-repatriate-Binance-US-assets.html)- The U.S. Securities and Exchange Commission (SEC) has filed an emergency restraining order to freeze the assets of Binance.US the day after filing a 13-charge lawsuit against Binance.
