...
- Spoločnosť Ingve vydala nástroj 'Fq', ktorý slúži na programové dokumentovanie binárnych formátov a prispievanie do centralizovaného úložiska
- Používatelia diskutujú o užitočnosti nástroja Fq pri ladení a analýze binárnych údajov a spomínajú alternatívne nástroje na vyhľadávanie v JSON
...
- Agresívna monetizačná taktika Redditu a zmeny API vyvolali kritiku zo strany používateľov a vývojárov aplikácií tretích strán
- Používatelia sú frustrovaní kvalitou signálov na platforme a presadzujú inštaláciu oficiálnej mobilnej aplikácie
...
- Používatelia spomínajú na používanie siete telnet na vysokej škole a na testovanie pripojenia k webovým serverom alebo iným službám
- Niektorí používatelia odporúčajú používať nc namiesto telnetu, zatiaľ čo iní argumentujú bezpečnosťou používania telnetu so zabezpečeným kanálom, ako je WireGuard
