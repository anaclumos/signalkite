...
- La version 1.50.0 de uBlock Origin a été publiée avec divers correctifs et changements
- La mise à jour ajoute de nouvelles fonctionnalités telles que la possibilité de supprimer des attributs et d'injecter des scriptlets dans le monde MAIN ou ISOLATED.
...
- Comparaison entre uBlock et uBlock Origin
- uBlock Origin est recommandé pour son authenticité et son caractère open-source.
...
- La SEC accorde une ordonnance restrictive d'urgence pour geler et rapatrier les actifs de Binance.US
- Critiques de l'incapacité de la communauté des crypto-monnaies à développer une utilisation des crypto-monnaies au-delà de la spéculation et de la criminalité.
