...
- O utilizador manifesta a sua frustração pela impossibilidade de recorrer da proibição e argumenta que se trata de uma infracção ao seu direito à liberdade de expressão.- A publicação suscitou grande atenção e debate sobre as práticas de censura e moderação das plataformas de redes sociais.
