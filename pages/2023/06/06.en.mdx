...
- Users report a decline in quality and accuracy of Google's search results, with an emphasis on sponsored content
...
### My Reddit account was banned after adding my subs to the protest

- The post details how a user added their subreddits to a protest for racial justice and was subsequently banned from the platform for violating community guidelines.
...
#### [Industry Reactions](http://news.ycombinator.com/item?id=36192195)

- Qwiklabs offers new Generative AI learning path on Google Cloud
...
- Apple unveils new Mac Studio with Apple Silicon and advanced ML capabilities during WWDC keynote
