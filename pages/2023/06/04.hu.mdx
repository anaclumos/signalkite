...
- A Reddit agresszív monetizációs taktikája és az API-változások kritikát váltottak ki a felhasználókból és a harmadik fél alkalmazásfejlesztőkből is
- A felhasználók frusztráltak a platformon található jelek minőségével kapcsolatban, és a hivatalos mobilalkalmazás telepítését sürgetik
