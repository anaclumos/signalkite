...
### [3. června 2023 [Brute.Fail: Sledujte selhání útoků hrubou silou v reálném čase](https://brute.fail/)- Brute.Fail ukazuje v reálném čase příklady útočníků, kteří se snaží proniknout na servery hádáním uživatelských jmen a hesel.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36169954)- Použití fail2ban může šetřit prostředky serveru tím, že zastaví odpovědi na útoky hrubou silou, ale nemusí jim zabránit.
...
### [Kalifornie utratila 17 miliard dolarů za bezdomovectví - nefunguje to](https://www.wsj.com/articles/california-homeless-population-oakland-wood-street-encampment-78d42cc3)- Kalifornie utratila na bezdomovectví 17 miliard dolarů, ale problém přetrvává.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36162154)- Kalifornie vynaložila na řešení bezdomovectví 17 miliard dolarů, ale nefunguje to, strategie "housing first" není v San Franciscu účinně uplatňována, přestože ve Finsku byla úspěšná.
...
### [Aplikace Reddit třetích stran jsou drceny zvyšováním cen](https://kotaku.com/reddit-third-party-3rd-apps-pricing-crush-ios-android-1850493992)- Aplikace třetích stran, jako jsou Apollo a Infinity, jsou vytlačovány z trhu kvůli novým poplatkům, které Reddit zavedl za přístup ke svému API.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36162235)- Aplikacím třetích stran Redditu se zvyšují ceny za přístup k API, což vyvolává obavy o vztah mezi Redditem a jeho uživateli.
...
### [Radiací zocelený Quine (2014)](https://github.com/mame/radiation-hardened-quine)- Radiation-hardened Quine je samočinný program napsaný v jazyce Ruby, který funguje, i když z kódu odstraníte znak.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36162164)- O radiačně odolný quine, který snese smazání jednoho znaku, aniž by to ovlivnilo jeho spustitelnost, se podělil hacker na serveru Hacker News.
...
### [Jak vytvořit efektní mapy výletů pomocí R a OpenStreetMap](https://www.andrewheiss.com/blog/2023/06/01/geocoding-routing-openstreetmap-r/)- Andrew Heiss vysvětluje, jak pomocí OpenStreetMap, R, `sf` a `ggplot2` vytvořil mapy výletů.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36159864)- Komentátoři diskutují o historických a geologických informacích o regionech na trase cesty.
...
### [Po 27 letech a Psion 3a je stále skvělý (2020)](https://mcgst.com/2020/12/01/27-years-later-and-the-psion-3a-is-still-wonderful/)- Psion 3a, PDA vydané v roce 1993, je i po 27 letech stále funkční a má mnoho inovativních funkcí.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36162265)- Techničtí nadšenci diskutují o Psionu 3a a vyjadřují nostalgii nad jeho tvarovým faktorem a uživatelsky přívětivým rozhraním.
...
### [Skenování záloh iPhonu kvůli stopám kompromitace pomocí "Operace Triangulace"](https://github.com/KasperskyLab/triangle_check)- Nový skript nazvaný Triangle Check dokáže skenovat zálohy iTunes na stopy kompromitace pomocí "Operace Triangulace".
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36164340)- Společnost Kaspersky Lab vydala nástroj "Operation Triangulation", který dokáže skenovat zálohy iPhonu a hledat kompromitaci.
...
### [Není špatně, že "🤦🏼♂".length == 7 (2019)](https://hsivonen.fi/string-length/)- Článek se zabývá různými způsoby, jakými programovací jazyky definují a měří délku řetězce, konkrétně pokud jde o Unicode a emoji.
...
#### [Reakce odvětví](http://news.ycombinator.com/item?id=36159443)- Článek pojednává o nejednoznačnosti atributu "length" pro řetězce a navrhuje jeho nahrazení přesnějšími deskriptory.
...
#### [Reakce průmyslu](http://news.ycombinator.com/item?id=36168068)- Gilbert Strang, slavný matematik a odborník na lineární algebru, odešel po 61 letech pedagogické kariéry do důchodu.
