...
- 'Rarbg on IPFS', ktorý obsahuje 826 201 magnetov a je rozdelený do niekoľkých kategórií
- Databáza SQLite môže mať chyby pri vyhľadávaní a používatelia dali odporúčania pre klientov IPFS
...
- Príspevok vtipne navrhuje použitie S3, zariadení TUN a kardio na obídenie nákladov na službu AWS Managed NAT Gateway
- Výsledný nástroj s názvom Hoshino umiestňuje odchádzajúce pakety IPv6 do S3 a načítava prichádzajúce pakety, čím zabezpečuje medziregionálnu komunikáciu, ktorá je z hľadiska operácií S3 smiešne drahá
...
- Diskusia o netradičných implementáciách front správ vrátane e-mailových a súborových systémov
- Zmienka o historických a alternatívnych systémoch frontu správ
