...
- uBlock Origin 1.50.0 har släppts med olika korrigeringar och ändringar
- Uppdateringen lägger till nya funktioner som möjligheten att ta bort attribut och injicera scriptlets i MAIN- eller ISOLATED-världen
- Den är tillgänglig för Firefox, Chromium, Edge och Opera, med väntan på installation och granskning för vissa plattformar.

#### [Reaktioner från branschen](http://news.ycombinator.com/item?id=36227411)

- Jämförelse mellan uBlock och uBlock Origin
- uBlock Origin rekommenderas för att den är äkta och har öppen källkod
...
- Avast har förvärvat tillägget "I don't care about cookies" och användare har uttryckt oro över integriteten.
...
### [Stöd för DirectX 12 på macOS](https://twitter.com/andytizer/status/1666131239575728130)
...
- SEC beviljar tillfälligt besöksförbud för att frysa och repatriera Binance.US tillgångar
- Kritik mot kryptosamfundets misslyckande med att utveckla en användning för kryptovalutor utöver spekulation och brott.
