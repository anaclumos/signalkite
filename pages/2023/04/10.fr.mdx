...
top_news: "L'effet LLama : Une fuite a déclenché une série d'alternatives Open Source
  à ChatGPT"
---
...
Un journaliste néerlandais est la cible d'un programme d'intimidation ; les utilisateurs de HN discutent de l'ingérence chinoise et exhortent les gouvernements à en faire plus. Des postes de police chinois opèrent aux Pays-Bas et dans d'autres pays, et les pays devront peut-être enquêter eux-mêmes sur ce que l'on appelle les "actions grises". Les critiques affirment que les actions de la Chine violent la souveraineté, et certains politiciens ont été menacés en conséquence. Les utilisateurs de HN discutent du rôle de la Chine dans les récentes alertes à la bombe contre des journalistes dissidents vivant aux États-Unis ; débats sur le gouvernement chinois et ses actions à l'égard des journalistes occidentaux. ASML, une entreprise néerlandaise, apparaît dans un contexte où la Chine vise à s'approprier l'électronique de l'Occident.
...
Un utilisateur de HN propose d'utiliser des expressions régulières binaires pour les relations linguistiques, tandis qu'un autre plaide en faveur du sens et de l'intention. Le créateur du bébé GPT le compare à une chaîne de Markov. Un expert recommande de meilleurs outils mathématiques. Un utilisateur de HN s'interroge sur les implications pour le grand public. Aucune nouvelle technologie ou publication notable.
...
Le moteur open-source Permafrost attire l'attention sur HN pour un nouveau jeu RTS open-source. La clarté de la police du jeu Everglory est critiquée. Comparaison demandée avec d'autres moteurs RTS. Les tests des développeurs sur les écrans d'ordinateur de poche sont importants. L'espoir d'un renouveau du genre RTS. Les utilisateurs discutent des moteurs RTS open-source et des langages utilisés. Mention d'une autre implémentation du moteur Frostbite en open-source.
...
### Show HN : Supavisor - un pooler de connexion Postgres écrit en Elixir
