...
### 2. huhtikuuta 2023 Amazon Echo -laitteet tallentavat WiFi-salasanat selkokielisenä tekstinä, jolloin ne ovat alttiita fyysiselle hyökkäykselle.
...
[HN](http://news.ycombinator.com/item?id=35399603), [Artikkeli](https://www.exhypothesi.com/clocks-and-causality/).
...
[HN](http://news.ycombinator.com/item?id=35397051), [Artikkeli](https://en.hexatrek.com).
...
[HN](http://news.ycombinator.com/item?id=35400047), [Artikkeli](https://raphlinus.github.io/rust/2023/04/01/rust-to-cpp.html).

### Kurssikaveri: Connecting Self-Learners Worldwide for Collaborative Online Learning.

**Näytä HN: Coursemate - yhteys muihin itseoppijoihin.**
...
[HN](http://news.ycombinator.com/item?id=35396156), [Artikkeli](<https://www.cell.com/cell/fulltext/S0092-8674(23)00262-3>).
...
[HN](http://news.ycombinator.com/item?id=35396165), [Artikkeli](https://sharegpt.com/c/ICZsSl7).
...
**Näytä HN: Käytä Chromen evästeitä (CDP) cURL:ssä ilman kopiointia ja liittämistä.**
