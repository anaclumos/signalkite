...
### 2 april 2023 Amazon Echo-enheter lagrar WiFi-lösenord i klartext, vilket gör dem sårbara för angrepp med fysisk åtkomst.
...
**Visa HN: Coursemate - anslut dig till andra självlärare.**
...
**Visa HN: Använd cookies från Chrome (CDP) i cURL utan att kopiera och klistra in.**
