...
- [Twitter's Recommendation Algorithm (HN)](http://news.ycombinator.com/item?id=35391433), [Article]({self.url})
...
- [Llama.cpp 30B runs with only 6GB of RAM now (HN)](http://news.ycombinator.com/item?id=35393284), [Article]({self.url})
...
- [AI-enhanced development makes me more ambitious with my projects (HN)](http://news.ycombinator.com/item?id=35382698), [Article]({self.url})
...
- [Postgres as a graph database (HN)](http://news.ycombinator.com/item?id=35386948), [Article]({self.url})
...
- [Italian privacy regulator bans ChatGPT (HN)](http://news.ycombinator.com/item?id=35385075), [Article]({self.url})
...
- [NYPD is refusing to comply with NYC's new surveillance tech laws (HN)](http://news.ycombinator.com/item?id=35387000), [Article]({self.url})
...
- [Could you train a ChatGPT-beating model for $85k and run it in a browser? (HN)](http://news.ycombinator.com/item?id=35391115), [Article]({self.url})
...
- [Police relied on Clearview AI and put the wrong person in jail (HN)](http://news.ycombinator.com/item?id=35389566), [Article]({self.url})
...
- [75% of the Most Played Games on Steam Are Playable on the Steam Deck (HN)](http://news.ycombinator.com/item?id=35387191), [Article]({self.url})
...
- [Show HN: Multi-display screen sharing with CoScreen (HN)](http://news.ycombinator.com/item?id=35387160), [Article]({self.url})
...
- [Janet for Mortals (HN)](http://news.ycombinator.com/item?id=35386405), [Article]({self.url})
...
- [CDC team studying East Palestine train derailment fell ill during investigation (HN)](http://news.ycombinator.com/item?id=35393458), [Article]({self.url})
...
- [Cosine Implementation in C (HN)](http://news.ycombinator.com/item?id=35381968), [Article]({self.url})
...
- [When SVG almost got network support for raw sockets (HN)](http://news.ycombinator.com/item?id=35381755), [Article]({self.url})
...
- [Heat pump sales outpaced gas furnace sales in the US in 2022 (HN)](http://news.ycombinator.com/item?id=35390853), [Article]({self.url})
