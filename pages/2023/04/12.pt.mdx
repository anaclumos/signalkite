...
O artigo discute o problema da banca global em transacções distribuídas e potenciais soluções utilizando redundância/quóruns, mas existem desafios de consistência. Menciona-se a lenta adopção de desenhos de bases de dados distribuídas e de relógios atómicos para alcançar a consistência global. Um utilizador HN aponta o MySQL Cluster e uma arquitectura de nada partilhado. Outros comentários mencionam o controlo de multiversões e a sincronização de carimbos temporais num sistema distribuído.
...
Scott Aaronson's GPT-4 AI obteve um B num exame de computação quântica de graduação, com pontos fortes em questões verdadeiro/falso e conceptuais, de acordo com um post no blog de Aaronson. As restrições práticas tornam difícil melhorar o desempenho da computação quântica, apesar da sua possibilidade teórica, e os utilizadores de HN discutem limitações e factores relacionados. Um utilizador fornece uma solução quântica para factorizar $N=105$ em $3\cdot 5 \cdot 7$.
...
### Mostrar HN: Salte o imposto SSO, aceda aos seus dados de utilizador com OSS
...
Um utilizador da HN partilha reacções emocionais ao impacto de Steve Jobs na vida das pessoas para além da tecnologia, ao mesmo tempo que reconhece a sua capacidade de formar equipas eficazes. Os utilizadores da HN discutem o complexo impacto de Steve Jobs na tecnologia, debatendo as suas competências em cuidados de saúde e reconhecendo a sua capacidade de liderança e marketing. Alguns utilizadores da HN elogiam o design da IU como essencial para uma boa experiência do utilizador, e outros creditam a atenção de Jobs aos detalhes pelos seus fantásticos produtos. O génio criativo dos empregos, as suas capacidades de marketing, e as suas capacidades de construção de equipas são notados como factores importantes no seu impacto na indústria, juntamente com a sua priorização de design de fácil utilização.
...
### Pergunta à HN: O mercado de trabalho é brutal? ou sou só eu?

O post Ask HN pergunta se o mercado de trabalho tecnológico é brutal ou se é apenas o fracasso do cartaz. As respostas indicam que pode ser uma combinação de ambos, com factores como a falta de experiência e concorrência a desempenharem um papel na dificuldade de encontrar um emprego. Um utilizador sugere o trabalho em rede e a construção de uma carteira para aumentar as hipóteses de sucesso.
