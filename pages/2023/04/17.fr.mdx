...
Le service d'archivage auto-hébergé Wabarc capture des pages web dans des "capsules temporelles" et stocke des fichiers pour une utilisation hors ligne ; cependant, les utilisateurs de HN critiquent le manque de clarté du README et le manque de documentation. D'autres projets similaires incluent ArchiveBox, Shiori, DiskerNet et SingleFile ; HTTrack Website Copier est recommandé pour télécharger localement un site web entier, tandis que Browsertrix/Brozzler explore avec des navigateurs sans tête pour la précision. Un utilisateur de HN recommande The Old Net pour naviguer dans des navigateurs anciens/modernes sans JS, et le repo lié a besoin de plus de clarté sur la partageabilité et les normes d'archivage établies.
