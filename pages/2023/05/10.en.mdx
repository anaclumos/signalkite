...
- The Public Order Bill in the UK raises concerns about compatibility with international human rights obligations, potentially infringing on freedom of expression, peaceful assembly, and association.
- The law grants expanded police powers, introduces vague criminal offenses, and imposes disproportionate sanctions on peaceful protestors, including serious disruption prevention orders that restrict individuals' movements and activities.
- UN High Commissioner for Human Rights Volker Türk calls for the UK Government to reverse the legislation, emphasizing the importance of protecting and facilitating peaceful protests, especially on existential issues like climate change and biodiversity loss.
...
- James Webb Space Telescope (JWST) captures unprecedented images of Fomalhaut's disk, revealing new belts and a dust cloud.
- Researchers find an innermost belt analogous to our solar system's asteroid belt, an intermediate belt, and a gap possibly carved by an unseen exoplanet.
- The "Great Dust Cloud" might have been formed by a planet-scale collision or could be a background galaxy, requiring further observation.
