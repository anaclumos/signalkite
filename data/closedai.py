...
Summarize in markdown, less than 500 'characters', end with a period for each sentence.
Text: {text}
""",
                },
            ],
...
Now, given the previous text, summarize the following hacker news comments in markdown, in less than 100 characters, end with a period for each sentence.
