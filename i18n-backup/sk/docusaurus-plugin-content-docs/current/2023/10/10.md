...
- Spoločnosť Unity plánuje čoskoro začať s hľadaním stáleho generálneho riaditeľa, zatiaľ čo Riccitiello bude aj naďalej plniť poradenskú funkciu počas prechodného obdobia.
...
## [Spoločnosť Google zmiernila doteraz najväčší útok DDoS s maximálnou rýchlosťou viac ako 398 miliónov rps](https://cloud.google.com/blog/products/identity-security/google-cloud-mitigated-largest-ddos-attack-peaking-above-398-million-rps/)
...
## [Stredoveké schodiská sa nestavali v smere hodinových ručičiek, aby mal obranca výhodu](https://fakehistoryhunter.net/2023/10/09/medieval-staircases-were-not-built-going-clockwise-for-the-defenders-advantage/)
...
- Rozhovor sa rozširuje na oblasti, ako sú obliehacie taktiky, architektúra hradov a historické udalosti. Je však badateľný nedostatok nespochybniteľných dôkazov a rôznych pohľadov na podporu jedného alebo druhého názoru.
...
### [Reakcie](https://news.ycombinator.com/item?id=37826357)
...
- Autor v závere zdôrazňuje význam siete na doručovanie obsahu (CDN) na zlepšenie prehrávania videa a ukladania do vyrovnávacej pamäte.
...
- V dialógu sa spomínajú riešenia na optimalizáciu a zabezpečenie videa, ako sú Gumlet a Mux, hoci v hlavnom texte sa podrobne neskúmajú pokročilé prístupy škálovania ani MPEG-DASH.
...
- Diskusia sa zameriava na použitie programovacieho jazyka Rust pri vývoji systému Android a komentuje jeho vhodnosť pre nízkoúrovňové programovanie a kompatibilitu s jazykom C.
...
## [Záznam DNS "hn.algolia.com" bol zrušený](https://www.nslookup.io/domains/hn.algolia.com/dns-records/)
...
- Článok objasňuje, že Linux využíva nevyužitú pamäť na ukladanie do medzipamäte disku, čo môže falošne indikovať nedostatok pamäte, ale nebráni behu aplikácií.
- Diskové ukladanie do vyrovnávacej pamäte zvyšuje výkon systému a nekradne aplikáciám pamäť, čím vyvracia mylné predstavy o využívaní pamäte.
- V článku sa neodporúča vypínať diskovú vyrovnávaciu pamäť vzhľadom na jej výhody pre aplikácie a zároveň sa ponúkajú spôsoby, ako presne vyhodnotiť dostupnú pamäť a identifikovať príznaky nedostatku pamäte.

### [Reakcie](https://news.ycombinator.com/item?id=37822927)

- Rozhovor sa sústreďuje na viaceré prvky správy pamäte v systémoch Linux, ako je transformácia prázdnej pamäte do vyrovnávacej pamäte a náklady na vyrovnávacie pamäte a správanie sa zabijaka pamäte (Out-of-Memory - OOM).
- Dôraz kladie aj na absenciu kompresie pamäte RAM, začlenenie swapu a kompresie pamäte RAM, následné účinky na výkon systému a odstránenie mylných predstáv o nevyužitej pamäti RAM.
- Účastníci sa podelia o osobné skúsenosti, navrhnú riešenia a vylepšenia a budú diskutovať o ťažkostiach a prekážkach týkajúcich sa správy pamäte v systéme Linux.

## [Zastaviť kontrolu chatu EÚ](https://stopchatcontrol.eu/)
...
- Štúdia naznačuje, že samokorekcia v LLM je účinnejšia, ak môžu využívať externé zdroje, ako je spätná väzba od ľudí alebo znalostná databáza; bez nich ich výkonnosť výrazne klesá.
...
### [Reakcie](https://news.ycombinator.com/item?id=37823543)
...
<head>
  ...
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=John%20Riccitiello%20odstupuje%20z%20funkcie%20gener%C3%A1lneho%20riadite%C4%BEa%20spolo%C4%8Dnosti%20Unity&subheading=pondelok%209.%20okt%C3%B3bra%202023%3A%20Hacker%20News%20Zhrnutie" />
</head>
