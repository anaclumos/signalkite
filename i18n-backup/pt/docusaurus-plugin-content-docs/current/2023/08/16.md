...
## [Reduzimos em 100 vezes o custo de criação do Mastodon na escala do Twitter](https://blog.redplanetlabs.com/2023/08/15/how-we-reduced-the-cost-of-building-twitter-at-twitter-scale-by-100x/)
...
### [Reações](https://news.ycombinator.com/item?id=37137110)
...
## [Firefox finalmente supera o desempenho do Google Chrome no SunSpider](https://www.phoronix.com/news/Firefox-Faster-SunSpider)

- O Firefox ultrapassou o Google Chrome no benchmark SunSpider JavaScript, marcando uma conquista significativa para os desenvolvedores da Mozilla.
- Apesar desse sucesso, o Chrome continua a superar o Firefox no benchmark JetStream 2.0, mais exigente.
- O Firefox se concentrou em melhorar a velocidade de upload e introduzir outros aprimoramentos para melhorar seu desempenho geral.

### [Reações](https://news.ycombinator.com/item?id=37134092)
...
## [O Manifesto OpenTF](https://opentf.org/)
...
### [Reações](https://news.ycombinator.com/item?id=37133054)
...
## [Como o LLaMa.cpp é possível?](https://finbarr.ca/how-is-llama-cpp-possible/)
...
### [Reações](https://news.ycombinator.com/item?id=37140013)
...
## [Opendream: Uma interface de usuário baseada em camadas para difusão estável](https://github.com/varunshenoy/opendream)
...
### [Reações](https://news.ycombinator.com/item?id=37136898)
...
## [Os ISPs reclamam que listar todas as taxas é muito difícil e pedem que a FCC elimine a nova regra](https://arstechnica.com/tech-policy/2023/08/isps-complain-that-listing-every-fee-is-too-hard-urge-fcc-to-scrap-new-rule/)
...
### [Reações](https://news.ycombinator.com/item?id=37138681)
...
## [Seletores CSS: Um guia visual](https://fffuel.co/css-selectors/)
...
### [Reações](https://news.ycombinator.com/item?id=37132754)

- O artigo se aprofunda nas funcionalidades dos seletores de CSS, explicando seus vários usos e fornecendo exemplos.
- São discutidos recursos avançados, como nth-child e seletores com valores específicos no início ou no final.
- O artigo também explora uma ferramenta para generalizar seletores de CSS e destaca a utilidade da sintaxe de expressão regular em CSS.

## [Como devo ler a notação do sistema de tipos?](https://langdev.stackexchange.com/questions/2692/how-should-i-read-type-system-notation)
...
### [Reações](https://news.ycombinator.com/item?id=37138807)
...
## [Por que hospedar seu próprio LLM?](http://marble.onl/posts/why_host_your_own_llm.html)
...
### [Reações](https://news.ycombinator.com/item?id=37133504)

- O artigo explora os motivos e os desafios dos modelos de modelo de linguagem (LLMs) auto-hospedados, em vez de depender da API da OpenAI.
- São discutidas opções alternativas para hospedar LLMs, como o Beam, hardware pessoal e a Tiny Box de George Hotz.
- A viabilidade e os benefícios dos LLMs auto-hospedados, incluindo a relação custo-benefício e as preocupações com a privacidade, são explorados.

## [CSV moderno versão 2](https://www.moderncsv.com/modern-csv-2-is-now-available/)

- O desenvolvedor do Modern CSV, Evan, lançou a versão 2 do editor/visualizador de arquivos tabulares para Windows, Mac e Linux.
- Essa nova versão apresenta vários aprimoramentos, incluindo uma interface de usuário/UX aprimorada, melhor desempenho, recursos adicionais, documentação atualizada e suporte nativo para o Apple Silicon.
- Os usuários são incentivados a experimentar a nova versão e fornecer feedback ao desenvolvedor.

### [Reações](https://news.ycombinator.com/item?id=37140159)

- O Modern CSV versão 2 foi lançado para Windows, Mac e Linux, oferecendo um editor/visualizador de arquivos tabulares avançado que aprimora o manuseio de arquivos CSV.
- A atualização vem com uma interface de usuário/UX aprimorada, melhor desempenho, mais recursos, documentação atualizada e suporte para o Apple Silicon.
- Os usuários recomendaram a reformulação da marca e o fornecimento de uma finalidade mais clara para o software, ao mesmo tempo em que discutiram opções alternativas, expressaram frustrações com o Excel e levantaram preocupações sobre a comunicação e o atraso nas atualizações.

<head>
  <meta property="og:title" content="Reduzimos em 100 vezes o custo de criação do Mastodon na escala do Twitter" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="https://og.cho.sh/api/og/?title=Reduzimos%20em%20100%20vezes%20o%20custo%20de%20cria%C3%A7%C3%A3o%20do%20Mastodon%20na%20escala%20do%20Twitter&subheading=quarta-feira,%2016%20de%20agosto%20de%202023:%20Resumo%20do%20Hacker%20News" />
</head>
