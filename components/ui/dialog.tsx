  ...
  return (
    <DialogPrimitives.Overlay
      ...
      className={cx(
        ...
        "bg-black/70",
        // transition
        "data-[state=open]:animate-dialogOverlayShow data-[state=closed]:animate-dialogOverlayHide",
        className,
      )}
      {...props}
    />
      ...
      <DialogOverlay>
        <DialogPrimitives.Content
          ...
          className={cx(
            ...
            // transition
            "data-[state=open]:animate-dialogContentShow data-[state=closed]:animate-dialogContentHide",
            focusRing,
            className,
          )}
